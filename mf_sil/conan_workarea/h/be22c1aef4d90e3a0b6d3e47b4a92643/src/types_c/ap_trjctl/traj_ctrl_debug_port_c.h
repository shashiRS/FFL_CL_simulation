...
#ifndef AP_TRJCTL_TRAJ_CTRL_DEBUG_PORT_C_H_
#define AP_TRJCTL_TRAJ_CTRL_DEBUG_PORT_C_H_
...
} AP_TRJCTL_TrajCtrlDebugPort;

inline AP_TRJCTL_TrajCtrlDebugPort create_AP_TRJCTL_TrajCtrlDebugPort(void)
{
  AP_TRJCTL_TrajCtrlDebugPort m;
  (void) ECO_memset (&m, 0, sizeof(m));
  m.sSigHeader = create_ECO_SignalHeader();
  return m;
}

#endif // AP_TRJCTL_TRAJ_CTRL_DEBUG_PORT_C_H_
