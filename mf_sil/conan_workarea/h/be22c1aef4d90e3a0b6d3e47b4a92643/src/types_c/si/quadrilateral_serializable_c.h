...
#ifndef SI_QUADRILATERAL_SERIALIZABLE_C_H_
#define SI_QUADRILATERAL_SERIALIZABLE_C_H_
...
} SI_QuadrilateralSerializable;

inline SI_QuadrilateralSerializable create_SI_QuadrilateralSerializable(void)
{
  SI_QuadrilateralSerializable m;
...
#endif // SI_QUADRILATERAL_SERIALIZABLE_C_H_
