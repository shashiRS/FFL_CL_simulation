...
#ifndef MF_HMIH_HEAD_UNIT_VISUALIZATION_PORT_C_H_
#define MF_HMIH_HEAD_UNIT_VISUALIZATION_PORT_C_H_
...
typedef struct
{
    ...
    MF_HMIH_HUCurrentFeatureState apaHuCurrentFeaturesState;
    ...
    MF_HMIH_HuCrossButton apaHuCrossButton;
    ...
    MF_HMIH_HuParkInSubFeatureState apaHuParkInSubFeatureState;
    ///This signal indicates current status of the APA Park Out sub-features
    MF_HMIH_HuParkOutSubFeatureState apaHuParkOutSubFeatureState;
    ///This signal indicates current status of the garage parking sub-features
    MF_HMIH_HuGarageParkSubFeatureState apaHuGarageParkSubFeatureState;
    ///This signal indicates current status of the SVS sub-features
    MF_HMIH_HuSVsSubFeatureState apaHuSVsSubFeatureState;
    ///This signal indicates current status of the Reverse Assist sub-features
    MF_HMIH_HuRaSubFeatureState apaHuRaSubFeatureState;
    ///This signal indicates the current status of the BVM  features
    MF_HMIH_HuBvmSubFeatureState apaHuBvmSubFeatureState;
    uint8 apaInteractionPauseCount;
    uint8 apaInteractionTimer;
    ///This signal Indicates the Pause condition messages
    MF_HMIH_HUIntrPauseCondition apaIntrPauseCondition;
    ///This signal Indicates the readiness of the frames
    MF_HMIH_HuFrameReady apaHuFrameReady;
} MF_HMIH_HeadUnitVisualizationPort;

inline MF_HMIH_HeadUnitVisualizationPort create_MF_HMIH_HeadUnitVisualizationPort(void)
{
  MF_HMIH_HeadUnitVisualizationPort m;
  (void) ECO_memset (&m, 0, sizeof(m));
  m.sSigHeader = create_ECO_SignalHeader();
  return m;
}

#endif // MF_HMIH_HEAD_UNIT_VISUALIZATION_PORT_C_H_
