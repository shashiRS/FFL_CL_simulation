...
#ifndef AP_COMMONVEHSIGPROVIDER_GPSDATA_C_H_
#define AP_COMMONVEHSIGPROVIDER_GPSDATA_C_H_
...
typedef struct
{
    ...
    ///
    AP_COMMONVEHSIGPROVIDER_Hemisphere gpsLatitudeHemisphere_nu;
    ///
    AP_COMMONVEHSIGPROVIDER_Hemisphere gpsLongitudeHemisphere_nu;
    ///@unit{day}
    ///@range{0,31}
    ///
    uint8 gpsDateDay_dd;
    ...
    ///GPS Receiver status
    AP_COMMONVEHSIGPROVIDER_GpsReceiverStatus ReceiverStatus_nu;
} AP_COMMONVEHSIGPROVIDER_GPSData;

inline AP_COMMONVEHSIGPROVIDER_GPSData create_AP_COMMONVEHSIGPROVIDER_GPSData(void)
{
  AP_COMMONVEHSIGPROVIDER_GPSData m;
  (void) ECO_memset (&m, 0, sizeof(m));
  return m;
}

#endif // AP_COMMONVEHSIGPROVIDER_GPSDATA_C_H_
