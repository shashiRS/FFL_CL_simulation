...
#ifndef MF_TONH_FC_MF_TONE_HANDLER_PARAMS_C_H_
#define MF_TONH_FC_MF_TONE_HANDLER_PARAMS_C_H_
...
} MF_TONH_FC_MF_ToneHandler_Params;

inline MF_TONH_FC_MF_ToneHandler_Params create_MF_TONH_FC_MF_ToneHandler_Params(void)
{
  MF_TONH_FC_MF_ToneHandler_Params m;
  (void) ECO_memset (&m, 0, sizeof(m));
  m.sSigHeader = create_ECO_SignalHeader();
  return m;
}

#endif // MF_TONH_FC_MF_TONE_HANDLER_PARAMS_C_H_
