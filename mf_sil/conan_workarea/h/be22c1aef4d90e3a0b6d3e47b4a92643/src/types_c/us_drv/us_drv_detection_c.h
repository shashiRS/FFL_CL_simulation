...
#ifndef US_DRV_US_DRV_DETECTION_C_H_
#define US_DRV_US_DRV_DETECTION_C_H_
...
typedef struct
{
    ...
    uint8 sensorId;
    US_DRV_UsDrvDetectionType detectionType;
    ///@range{0,65535}
    ///@unit{nu}
...
} US_DRV_UsDrvDetection;

inline US_DRV_UsDrvDetection create_US_DRV_UsDrvDetection(void)
{
  US_DRV_UsDrvDetection m;
  (void) ECO_memset (&m, 0, sizeof(m));
  return m;
}

#endif // US_DRV_US_DRV_DETECTION_C_H_
