...
#ifndef AP_COMMONVEHSIGPROVIDER_VEH_DYNAMICS_PORT_H_
#define AP_COMMONVEHSIGPROVIDER_VEH_DYNAMICS_PORT_H_
...
namespace ap_commonvehsigprovider
{
  ...
  inline ::ap_commonvehsigprovider::VehDynamicsPort createVehDynamicsPort()
  {
    VehDynamicsPort m;
    (void)::eco::memset(&m, 0U, sizeof(VehDynamicsPort));
...
namespace eco
{
  ...
  template<>
  inline ::ap_commonvehsigprovider::VehDynamicsPort create_default()
  {
      return ::ap_commonvehsigprovider::createVehDynamicsPort();
  }
}


#endif // AP_COMMONVEHSIGPROVIDER_VEH_DYNAMICS_PORT_H_
