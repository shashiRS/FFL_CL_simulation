...
namespace avga_swc
{
  ...
  public:
    ...
    SupervisionStateType() :
      value(static_cast< underlying_type >(AVGA_OFF))
    {
    }

    SupervisionStateType(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    SupervisionStateType(const SupervisionStateType& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END SupervisionStateType(const underlying_type v) :
      value(v)
    {
    }
    ...
    SupervisionStateType& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(SupervisionStateType&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    SupervisionStateType& operator=(const SupervisionStateType& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
