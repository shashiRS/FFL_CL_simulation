...
namespace ap_trjctl
{
  ...
  struct LoDMCCtrlRequestPort
  {
    ...
    LoDMCCtrlRequestInterfaceType loDMCCtrlRequestInterface_nu;
    ///@range{0,4}
  ...
  inline ::ap_trjctl::LoDMCCtrlRequestPort createLoDMCCtrlRequestPort()
  {
    LoDMCCtrlRequestPort m;
    (void)::eco::memset(&m, 0U, sizeof(LoDMCCtrlRequestPort));
    m.sSigHeader = ::eco::createSignalHeader();
    m.loDMCCtrlRequestInterface_nu = ::ap_trjctl::LoDMCCtrlRequestInterfaceType::MAX_NUM_LODMC_REQUEST_INTERFACE_TYPE;
    return m;
  }
...
namespace eco
{
  ...
  template<>
  inline ::ap_trjctl::LoDMCCtrlRequestPort create_default()
  {
      return ::ap_trjctl::createLoDMCCtrlRequestPort();
  }
}
