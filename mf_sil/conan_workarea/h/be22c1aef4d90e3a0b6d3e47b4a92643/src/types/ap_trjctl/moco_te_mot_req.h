...
namespace ap_trjctl
{
  ...
  public:
    ...
    MOCO_te_MotReq() :
      value(static_cast< underlying_type >(MOCO_MOT_REQ_SUPPRESS_STANDSTILL))
    {
    }

    MOCO_te_MotReq(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    MOCO_te_MotReq(const MOCO_te_MotReq& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END MOCO_te_MotReq(const underlying_type v) :
      value(v)
    {
    }
    ...
    MOCO_te_MotReq& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(MOCO_te_MotReq&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    MOCO_te_MotReq& operator=(const MOCO_te_MotReq& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
