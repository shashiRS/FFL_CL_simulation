...
#ifndef MF_LSCA_CONFIG_DEVELOPER_T_H_
#define MF_LSCA_CONFIG_DEVELOPER_T_H_
...
namespace mf_lsca
{
  ...
  inline ::mf_lsca::configDeveloper_t createconfigDeveloper_t()
  {
    configDeveloper_t m;
    (void)::eco::memset(&m, 0U, sizeof(configDeveloper_t));
    return m;
  }
...
namespace eco
{
  ...
  template<>
  inline ::mf_lsca::configDeveloper_t create_default()
  {
      return ::mf_lsca::createconfigDeveloper_t();
  }
}


#endif // MF_LSCA_CONFIG_DEVELOPER_T_H_
