...
namespace lsm_vedodo
{
  ...
  inline ::lsm_vedodo::OdoDebugPort createOdoDebugPort()
  {
    OdoDebugPort m;
    (void)::eco::memset(&m, 0U, sizeof(OdoDebugPort));
...
namespace eco
{
  ...
  template<>
  inline ::lsm_vedodo::OdoDebugPort create_default()
  {
      return ::lsm_vedodo::createOdoDebugPort();
  }
}
