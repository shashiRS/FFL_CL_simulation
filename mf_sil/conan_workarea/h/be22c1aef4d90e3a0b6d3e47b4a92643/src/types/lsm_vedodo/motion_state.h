...
#ifndef LSM_VEDODO_MOTION_STATE_H_
#define LSM_VEDODO_MOTION_STATE_H_
...
namespace lsm_vedodo
{
  ...
  public:
    ...
    {
      ODO_STANDSTILL = 0U,
      ODO_NO_STANDSTILL = 1U
    };

    MotionState() :
      value(static_cast< underlying_type >(ODO_STANDSTILL))
    {
    }

    MotionState(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    MotionState(const MotionState& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END MotionState(const underlying_type v) :
      value(v)
    {
    }
    ...
    MotionState& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(MotionState&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    MotionState& operator=(const MotionState& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
...
#endif // LSM_VEDODO_MOTION_STATE_H_
