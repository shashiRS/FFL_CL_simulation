...
namespace lsm_vedodo
{
  ...
  inline ::lsm_vedodo::FC_VEDODO_Params createFC_VEDODO_Params()
  {
    FC_VEDODO_Params m;
    (void)::eco::memset(&m, 0U, sizeof(FC_VEDODO_Params));
...
namespace eco
{
  ...
  template<>
  inline ::lsm_vedodo::FC_VEDODO_Params create_default()
  {
      return ::lsm_vedodo::createFC_VEDODO_Params();
  }
}
