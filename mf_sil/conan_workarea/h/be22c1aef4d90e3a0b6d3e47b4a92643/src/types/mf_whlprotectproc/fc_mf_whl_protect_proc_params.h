...
namespace mf_whlprotectproc
{
  ...
  inline ::mf_whlprotectproc::FC_MF_WhlProtectProc_Params createFC_MF_WhlProtectProc_Params()
  {
    FC_MF_WhlProtectProc_Params m;
    (void)::eco::memset(&m, 0U, sizeof(FC_MF_WhlProtectProc_Params));
...
namespace eco
{
  ...
  template<>
  inline ::mf_whlprotectproc::FC_MF_WhlProtectProc_Params create_default()
  {
      return ::mf_whlprotectproc::createFC_MF_WhlProtectProc_Params();
  }
}
