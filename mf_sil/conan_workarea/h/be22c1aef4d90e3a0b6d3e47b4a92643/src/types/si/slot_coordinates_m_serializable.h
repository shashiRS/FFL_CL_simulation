...
namespace si
{
  ...
  inline ::si::SlotCoordinates_mSerializable createSlotCoordinates_mSerializable()
  {
    SlotCoordinates_mSerializable m;
    (void)::eco::memset(&m, 0U, sizeof(SlotCoordinates_mSerializable));
    {
...
namespace eco
{
  ...
  template<>
  inline ::si::SlotCoordinates_mSerializable create_default()
  {
      return ::si::createSlotCoordinates_mSerializable();
  }
}
