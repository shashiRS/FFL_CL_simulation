...
namespace si
{
  ...
  public:
    ...
    PB_Side() :
      value(static_cast< underlying_type >(PB_SIDE_LEFT))
    {
    }

    PB_Side(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    PB_Side(const PB_Side& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END PB_Side(const underlying_type v) :
      value(v)
    {
    }
    ...
    PB_Side& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(PB_Side&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    PB_Side& operator=(const PB_Side& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
