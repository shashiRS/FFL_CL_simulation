...
namespace si
{
  ...
  inline ::si::SlotCostFunDataPerOptPhase createSlotCostFunDataPerOptPhase()
  {
    SlotCostFunDataPerOptPhase m;
    (void)::eco::memset(&m, 0U, sizeof(SlotCostFunDataPerOptPhase));
    m.roiLeft = createQuadrilateralSerializable();
    m.roiRight = createQuadrilateralSerializable();
    m.roiCurb = createQuadrilateralSerializable();
    m.virtualLines = createVirtualLineSerializableArray();
    m.bestVLIndices = createVirtualLineIndexSerializable();
...
namespace eco
{
  ...
  template<>
  inline ::si::SlotCostFunDataPerOptPhase create_default()
  {
      return ::si::createSlotCostFunDataPerOptPhase();
  }
}
