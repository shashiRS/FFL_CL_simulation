...
namespace si
{
  ...
  struct CorePlotData
  {
    ...
    ParkingScenarioTypes lastEstimatedScenario_nu;
    ParkingScenarioSideTypes lastEstimatedScenarioSide_nu;
  ...
  inline ::si::CorePlotData createCorePlotData()
  {
    CorePlotData m;
    (void)::eco::memset(&m, 0U, sizeof(CorePlotData));
    m.pullRects = createPullCornerRectSerializable();
    m.pullPolys = createPullCornerPolySerializable();
    m.parkingSlotUpdateRoi = createQuadrilateralSerializable();
    m.parkingSlotTrackingRoi = createQuadrilateralSerializable();
    m.perpendicular = createCoreSlotPrototype();
    m.parallel = createCoreSlotPrototype();
    m.garage = createCoreSlotPrototype();
    m.rawGpParkingSlots = createQuadrilateralSerializableArray();
    m.diagonalActual = createQuadrilateralSerializableArray();
    m.positionManagerInitialSlots = createQuadrilateralSerializableArray();
    m.positionManagerRois = createQuadrilateralSerializableArray();
    m.positionManagerAdjustedRois = createQuadrilateralSerializableArray();
    m.blowUpManagerRoiLeft = createQuadrilateralSerializableArray();
    m.blowUpManagerAdjustedRoiLeft = createQuadrilateralSerializableArray();
    m.blowUpManagerRoiRight = createQuadrilateralSerializableArray();
    m.blowUpManagerAdjustedRoiRight = createQuadrilateralSerializableArray();
    m.blowUpManagerRoiCurb = createQuadrilateralSerializableArray();
    m.blowUpManagerAdjustedRoiCurb = createQuadrilateralSerializableArray();
    m.collisionManagerResult = createOptimizationResultSerializable();
    m.slotOpeningBeforeExtension = createLineSegmentSerializableArray();
    m.selectedSlot_nu = 65535U;
    m.sensingArea = createQuadrilateralSerializable();
    m.roiLeft = createQuadrilateralSerializable();
    m.roiRight = createQuadrilateralSerializable();
    m.roiFront = createQuadrilateralSerializable();
    m.roiLeftCore = createQuadrilateralSerializable();
    m.roiRightCore = createQuadrilateralSerializable();
    m.newDetectedSlotCandidate = createNewDetectedSlotCandidateSerializable();
    m.lastEstimatedScenario_nu = ::si::ParkingScenarioTypes::MAX_NUM_PARKING_SCENARIO_TYPES;
    m.lastEstimatedScenarioSide_nu = ::si::ParkingScenarioSideTypes::MAX_NUM_PARKING_SCENARIO_SIDE_TYPES;
    m.irrelevantObjId = createUint16Serializable();
    m.scores = createSint32Serializable();
    return m;
  }
...
namespace eco
{
  ...
  template<>
  inline ::si::CorePlotData create_default()
  {
      return ::si::createCorePlotData();
  }
}
