...
#ifndef SI_SI_PARAMS_H_
#define SI_SI_PARAMS_H_
...
namespace si
{
  ...
  inline ::si::SiParams createSiParams()
  {
    SiParams m;
    (void)::eco::memset(&m, 0U, sizeof(SiParams));
...
namespace eco
{
  ...
  template<>
  inline ::si::SiParams create_default()
  {
      return ::si::createSiParams();
  }
}


#endif // SI_SI_PARAMS_H_
