...
namespace mf_hmih
{
  ...
  public:
    ...
    HuCrossButton(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    HuCrossButton(const HuCrossButton& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END HuCrossButton(const underlying_type v) :
      value(v)
    {
    }
    ...
    HuCrossButton& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(HuCrossButton&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    HuCrossButton& operator=(const HuCrossButton& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
