...
namespace mf_hmih
{
  ...
  public:
    ...
    SelectedDirection() :
      value(static_cast< underlying_type >(SEL_DIR_FORWARDS))
    {
    }

    SelectedDirection(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    SelectedDirection(const SelectedDirection& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END SelectedDirection(const underlying_type v) :
      value(v)
    {
    }
    ...
    SelectedDirection& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(SelectedDirection&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    SelectedDirection& operator=(const SelectedDirection& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
