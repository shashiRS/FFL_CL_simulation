...
namespace mf_hmih
{
  ...
  inline ::mf_hmih::HMIGeneral createHMIGeneral()
  {
    HMIGeneral m;
    (void)::eco::memset(&m, 0U, sizeof(HMIGeneral));
...
namespace eco
{
  ...
  template<>
  inline ::mf_hmih::HMIGeneral create_default()
  {
      return ::mf_hmih::createHMIGeneral();
  }
}
