...
#ifndef MF_HMIH_FC_MFHMIH_PARAMS_H_
#define MF_HMIH_FC_MFHMIH_PARAMS_H_
...
namespace mf_hmih
{
  ...
  inline ::mf_hmih::FC_MFHMIH_Params createFC_MFHMIH_Params()
  {
    FC_MFHMIH_Params m;
    (void)::eco::memset(&m, 0U, sizeof(FC_MFHMIH_Params));
...
namespace eco
{
  ...
  template<>
  inline ::mf_hmih::FC_MFHMIH_Params create_default()
  {
      return ::mf_hmih::createFC_MFHMIH_Params();
  }
}


#endif // MF_HMIH_FC_MFHMIH_PARAMS_H_
