...
namespace mf_hmih
{
  ...
  public:
    ...
    HuSVsSubFeatureState() :
      value(static_cast< underlying_type >(UNUSED))
    {
    }

    HuSVsSubFeatureState(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    HuSVsSubFeatureState(const HuSVsSubFeatureState& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END HuSVsSubFeatureState(const underlying_type v) :
      value(v)
    {
    }
    ...
    HuSVsSubFeatureState& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(HuSVsSubFeatureState&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    HuSVsSubFeatureState& operator=(const HuSVsSubFeatureState& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
