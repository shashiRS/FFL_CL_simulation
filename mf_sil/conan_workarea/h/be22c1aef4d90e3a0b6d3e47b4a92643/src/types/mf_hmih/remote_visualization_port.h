...
namespace mf_hmih
{
  ...
  inline ::mf_hmih::RemoteVisualizationPort createRemoteVisualizationPort()
  {
    RemoteVisualizationPort m;
    (void)::eco::memset(&m, 0U, sizeof(RemoteVisualizationPort));
...
namespace eco
{
  ...
  template<>
  inline ::mf_hmih::RemoteVisualizationPort create_default()
  {
      return ::mf_hmih::createRemoteVisualizationPort();
  }
}
