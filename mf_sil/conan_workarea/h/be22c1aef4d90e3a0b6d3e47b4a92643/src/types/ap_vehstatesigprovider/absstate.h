...
namespace ap_vehstatesigprovider
{
  ...
  public:
    ...
    ABSState() :
      value(static_cast< underlying_type >(ABS_INACTIVE))
    {
    }

    ABSState(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    ABSState(const ABSState& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END ABSState(const underlying_type v) :
      value(v)
    {
    }
    ...
    ABSState& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(ABSState&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    ABSState& operator=(const ABSState& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
