...
#ifndef AP_VEHSTATESIGPROVIDER_EBDSTATE_H_
#define AP_VEHSTATESIGPROVIDER_EBDSTATE_H_
...
namespace ap_vehstatesigprovider
{
  ...
  public:
    ...
    EBDState() :
      value(static_cast< underlying_type >(EBD_INACTIVE))
    {
    }

    EBDState(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    EBDState(const EBDState& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END EBDState(const underlying_type v) :
      value(v)
    {
    }
    ...
    EBDState& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(EBDState&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    EBDState& operator=(const EBDState& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
...
#endif // AP_VEHSTATESIGPROVIDER_EBDSTATE_H_
