...
namespace ap_vehstatesigprovider
{
  ...
  public:
    ...
    TCSState() :
      value(static_cast< underlying_type >(TCS_INACTIVE))
    {
    }

    TCSState(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    TCSState(const TCSState& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END TCSState(const underlying_type v) :
      value(v)
    {
    }
    ...
    TCSState& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(TCSState&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    TCSState& operator=(const TCSState& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
