...
namespace ap_psm_app
{
  ...
  public:
    ...
    RemoteMode() :
      value(static_cast< underlying_type >(REM_MODE_INACTIVE))
    {
    }

    RemoteMode(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    RemoteMode(const RemoteMode& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END RemoteMode(const underlying_type v) :
      value(v)
    {
    }
    ...
    RemoteMode& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(RemoteMode&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    RemoteMode& operator=(const RemoteMode& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
