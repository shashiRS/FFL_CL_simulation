...
namespace ap_psm_app
{
  ...
  public:
    ...
    VSMState() :
      value(static_cast< underlying_type >(VSM_INACTIVE))
    {
    }

    VSMState(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    VSMState(const VSMState& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END VSMState(const underlying_type v) :
      value(v)
    {
    }
    ...
    VSMState& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(VSMState&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    VSMState& operator=(const VSMState& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
