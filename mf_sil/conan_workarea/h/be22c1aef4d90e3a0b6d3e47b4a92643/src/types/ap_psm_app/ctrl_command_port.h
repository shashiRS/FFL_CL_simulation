...
namespace ap_psm_app
{
  ...
  inline ::ap_psm_app::CtrlCommandPort createCtrlCommandPort()
  {
    CtrlCommandPort m;
    (void)::eco::memset(&m, 0U, sizeof(CtrlCommandPort));
...
namespace eco
{
  ...
  template<>
  inline ::ap_psm_app::CtrlCommandPort create_default()
  {
      return ::ap_psm_app::createCtrlCommandPort();
  }
}
