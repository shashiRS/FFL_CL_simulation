...
namespace ap_psm_app
{
  ...
  inline ::ap_psm_app::OverrideLSCAPort createOverrideLSCAPort()
  {
    OverrideLSCAPort m;
    (void)::eco::memset(&m, 0U, sizeof(OverrideLSCAPort));
...
namespace eco
{
  ...
  template<>
  inline ::ap_psm_app::OverrideLSCAPort create_default()
  {
      return ::ap_psm_app::createOverrideLSCAPort();
  }
}
