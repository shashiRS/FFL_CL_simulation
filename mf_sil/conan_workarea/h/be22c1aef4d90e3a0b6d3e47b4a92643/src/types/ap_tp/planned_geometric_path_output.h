...
namespace ap_tp
{
  ...
  inline ::ap_tp::PlannedGeometricPathOutput createPlannedGeometricPathOutput()
  {
    PlannedGeometricPathOutput m;
    (void)::eco::memset(&m, 0U, sizeof(PlannedGeometricPathOutput));
    return m;
  }
...
namespace eco
{
  ...
  template<>
  inline ::ap_tp::PlannedGeometricPathOutput create_default()
  {
      return ::ap_tp::createPlannedGeometricPathOutput();
  }
}
