...
namespace ap_tp
{
  ...
  inline ::ap_tp::PlannedTrajPort createPlannedTrajPort()
  {
    PlannedTrajPort m;
    (void)::eco::memset(&m, 0U, sizeof(PlannedTrajPort));
    m.sSigHeader = ::eco::createSignalHeader();
    m.trajType_nu = ::ap_tp::PlannedTrajType::MAX_NUM_PLANNED_TRAJ_TYPES;
    ...
    }
    {
      ...
      for(uint64 i = 0U; i < arraysize; ++i)
      {
        m.plannedTraj[i] = createPlannedTraj();
      }
    }
    return m;
  }
...
namespace eco
{
  ...
  template<>
  inline ::ap_tp::PlannedTrajPort create_default()
  {
      return ::ap_tp::createPlannedTrajPort();
  }
}
