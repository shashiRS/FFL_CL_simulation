...
#ifndef AP_PSM_RMSTATE_H_
#define AP_PSM_RMSTATE_H_
...
namespace ap_psm
{
  ...
  public:
    ...
    RMState() :
      value(static_cast< underlying_type >(RM_INACTIVE))
    {
    }

    RMState(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    RMState(const RMState& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END RMState(const underlying_type v) :
      value(v)
    {
    }
    ...
    RMState& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(RMState&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    RMState& operator=(const RMState& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
