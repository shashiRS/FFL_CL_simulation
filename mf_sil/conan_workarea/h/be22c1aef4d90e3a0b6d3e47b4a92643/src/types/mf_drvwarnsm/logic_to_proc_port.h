...
namespace mf_drvwarnsm
{
  ...
  inline ::mf_drvwarnsm::LogicToProcPort createLogicToProcPort()
  {
    LogicToProcPort m;
    (void)::eco::memset(&m, 0U, sizeof(LogicToProcPort));
...
namespace eco
{
  ...
  template<>
  inline ::mf_drvwarnsm::LogicToProcPort create_default()
  {
      return ::mf_drvwarnsm::createLogicToProcPort();
  }
}
