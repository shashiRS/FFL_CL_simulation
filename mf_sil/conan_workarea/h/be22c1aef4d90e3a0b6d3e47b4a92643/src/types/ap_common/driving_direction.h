...
namespace ap_common
{
  ...
  public:
    ...
    DrivingDirection() :
      value(static_cast< underlying_type >(DIRECTION_UNKNOWN))
    {
    }

    DrivingDirection(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DrivingDirection(const DrivingDirection& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END DrivingDirection(const underlying_type v) :
      value(v)
    {
    }
    ...
    DrivingDirection& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(DrivingDirection&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    DrivingDirection& operator=(const DrivingDirection& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
