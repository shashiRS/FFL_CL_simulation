...
namespace ecu_ctrl
{
  ...
  public:
    ...
    TempState() :
      value(static_cast< underlying_type >(TEMP_STATE_INIT))
    {
    }

    TempState(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    TempState(const TempState& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END TempState(const underlying_type v) :
      value(v)
    {
    }
    ...
    TempState& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(TempState&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    TempState& operator=(const TempState& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
