...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='us_em/dynamic_obj_shape_serializable.proto',
  package='pb.us_em.dynamic_obj_shape_serializable',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=b'\n*us_em/dynamic_obj_shape_serializable.proto\x12\'pb.us_em.dynamic_obj_shape_serializable\x1a\x15\x63ml/vec2_df_pod.proto\"b\n\x1b\x44ynamicObjShapeSerializable\x12\x13\n\nactualSize\x18\xc1\x17 \x01(\r\x12.\n\x05\x61rray\x18\xb9\x18 \x03(\x0b\x32\x1e.pb.cml.vec2_df_pod.Vec2Df_POD\"}\n&DynamicObjShapeSerializable_array_port\x12S\n\x04\x64\x61ta\x18\xdf\x19 \x03(\x0b\x32\x44.pb.us_em.dynamic_obj_shape_serializable.DynamicObjShapeSerializable'
  ,
...
_DYNAMICOBJSHAPESERIALIZABLE = _descriptor.Descriptor(
  ...
  full_name='pb.us_em.dynamic_obj_shape_serializable.DynamicObjShapeSerializable',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='actualSize', full_name='pb.us_em.dynamic_obj_shape_serializable.DynamicObjShapeSerializable.actualSize', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='array', full_name='pb.us_em.dynamic_obj_shape_serializable.DynamicObjShapeSerializable.array', index=1,
...
_DYNAMICOBJSHAPESERIALIZABLE_ARRAY_PORT = _descriptor.Descriptor(
  ...
  full_name='pb.us_em.dynamic_obj_shape_serializable.DynamicObjShapeSerializable_array_port',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='data', full_name='pb.us_em.dynamic_obj_shape_serializable.DynamicObjShapeSerializable_array_port.data', index=0,
      number=3295, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
...
DynamicObjShapeSerializable = _reflection.GeneratedProtocolMessageType('DynamicObjShapeSerializable', (_message.Message,), {
  ...
  '__module__' : 'us_em.dynamic_obj_shape_serializable_pb2'
