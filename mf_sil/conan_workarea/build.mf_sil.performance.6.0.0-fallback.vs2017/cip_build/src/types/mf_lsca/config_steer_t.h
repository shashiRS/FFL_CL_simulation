...
#ifndef MF_LSCA_CONFIG_STEER_T_H_
#define MF_LSCA_CONFIG_STEER_T_H_
...
namespace mf_lsca
{
  ...
  inline ::mf_lsca::configSteer_t createconfigSteer_t()
  {
    configSteer_t m;
    (void)::eco::memset(&m, 0U, sizeof(configSteer_t));
    m.proposalData = createconfigSteerPropose_t();
    m.maxSteeringAngleLimits_deg = ::cml::createVec2Df_POD();
    m.maxSteeringAngleDelta_deg = ::cml::createVec2Df_POD();
    m.maxSteeringTorqueLimits_Nm = ::cml::createVec2Df_POD();
    m.maxSteeringTorqueDelta_Nms = ::cml::createVec2Df_POD();
    m.resistanceData = createconfigSteerResist_t();
    return m;
  }
...
namespace eco
{
  ...
  template<>
  inline ::mf_lsca::configSteer_t create_default()
  {
      return ::mf_lsca::createconfigSteer_t();
  }
}


#endif // MF_LSCA_CONFIG_STEER_T_H_
