...
namespace mf_lsca
{
  ...
  inline ::mf_lsca::LscaEgoWheelShapeSerializable createLscaEgoWheelShapeSerializable()
  {
    LscaEgoWheelShapeSerializable m;
    (void)::eco::memset(&m, 0U, sizeof(LscaEgoWheelShapeSerializable));
    {
...
namespace eco
{
  ...
  template<>
  inline ::mf_lsca::LscaEgoWheelShapeSerializable create_default()
  {
      return ::mf_lsca::createLscaEgoWheelShapeSerializable();
  }
}
