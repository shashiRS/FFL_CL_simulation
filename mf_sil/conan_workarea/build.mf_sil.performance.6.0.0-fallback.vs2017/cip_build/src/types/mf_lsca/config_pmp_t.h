...
namespace mf_lsca
{
  ...
  inline ::mf_lsca::configPmp_t createconfigPmp_t()
  {
    configPmp_t m;
    (void)::eco::memset(&m, 0U, sizeof(configPmp_t));
    return m;
  }
...
namespace eco
{
  ...
  template<>
  inline ::mf_lsca::configPmp_t create_default()
  {
      return ::mf_lsca::createconfigPmp_t();
  }
}
