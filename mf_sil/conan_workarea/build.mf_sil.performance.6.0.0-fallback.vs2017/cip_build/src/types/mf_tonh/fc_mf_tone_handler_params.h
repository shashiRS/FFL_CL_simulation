...
namespace mf_tonh
{
  ...
  inline ::mf_tonh::FC_MF_ToneHandler_Params createFC_MF_ToneHandler_Params()
  {
    FC_MF_ToneHandler_Params m;
    (void)::eco::memset(&m, 0U, sizeof(FC_MF_ToneHandler_Params));
...
namespace eco
{
  ...
  template<>
  inline ::mf_tonh::FC_MF_ToneHandler_Params create_default()
  {
      return ::mf_tonh::createFC_MF_ToneHandler_Params();
  }
}
