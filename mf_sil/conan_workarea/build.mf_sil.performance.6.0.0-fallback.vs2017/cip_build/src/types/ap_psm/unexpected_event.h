...
#ifndef AP_PSM_UNEXPECTED_EVENT_H_
#define AP_PSM_UNEXPECTED_EVENT_H_
...
namespace ap_psm
{
  ...
  public:
    ...
    {
      NO_EVENT = 0U,
      DRIVER_STEERING_INTERVENTION = 1U
    };

    UnexpectedEvent() :
      value(static_cast< underlying_type >(NO_EVENT))
    {
    }

    UnexpectedEvent(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    UnexpectedEvent(const UnexpectedEvent& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END UnexpectedEvent(const underlying_type v) :
      value(v)
    {
    }
    ...
    UnexpectedEvent& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(UnexpectedEvent&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    UnexpectedEvent& operator=(const UnexpectedEvent& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
...
#endif // AP_PSM_UNEXPECTED_EVENT_H_
