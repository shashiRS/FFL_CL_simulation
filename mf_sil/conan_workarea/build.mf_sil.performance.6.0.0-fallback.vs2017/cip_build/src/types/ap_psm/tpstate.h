...
namespace ap_psm
{
  ...
  public:
    ...
    TPState() :
      value(static_cast< underlying_type >(TP_INACTIVE))
    {
    }

    TPState(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    TPState(const TPState& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END TPState(const underlying_type v) :
      value(v)
    {
    }
    ...
    TPState& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(TPState&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    TPState& operator=(const TPState& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
