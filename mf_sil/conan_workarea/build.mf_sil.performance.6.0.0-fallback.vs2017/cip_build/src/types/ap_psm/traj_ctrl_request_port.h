...
namespace ap_psm
{
  ...
  inline ::ap_psm::TrajCtrlRequestPort createTrajCtrlRequestPort()
  {
    TrajCtrlRequestPort m;
    (void)::eco::memset(&m, 0U, sizeof(TrajCtrlRequestPort));
...
namespace eco
{
  ...
  template<>
  inline ::ap_psm::TrajCtrlRequestPort create_default()
  {
      return ::ap_psm::createTrajCtrlRequestPort();
  }
}
