...
namespace us_em
{
  ...
  public:
    ...
    ObjMeasurementState() :
      value(static_cast< underlying_type >(MEAS_STATE_NEW))
    {
    }

    ObjMeasurementState(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    ObjMeasurementState(const ObjMeasurementState& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END ObjMeasurementState(const underlying_type v) :
      value(v)
    {
    }
    ...
    ObjMeasurementState& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(ObjMeasurementState&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    ObjMeasurementState& operator=(const ObjMeasurementState& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
