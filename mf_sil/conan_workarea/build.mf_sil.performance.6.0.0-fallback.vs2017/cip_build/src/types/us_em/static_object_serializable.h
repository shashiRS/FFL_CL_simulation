...
namespace us_em
{
  ...
  inline ::us_em::StaticObjectSerializable createStaticObjectSerializable()
  {
...
namespace eco
{
  ...
  template<>
  inline ::us_em::StaticObjectSerializable create_default()
  {
      return ::us_em::createStaticObjectSerializable();
  }
}
