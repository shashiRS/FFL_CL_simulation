...
namespace lsm_vedodo
{
  ...
  inline ::lsm_vedodo::OdoEstimation createOdoEstimation()
  {
    OdoEstimation m;
    (void)::eco::memset(&m, 0U, sizeof(OdoEstimation));
...
namespace eco
{
  ...
  template<>
  inline ::lsm_vedodo::OdoEstimation create_default()
  {
      return ::lsm_vedodo::createOdoEstimation();
  }
}
