...
#ifndef AP_PSM_APP_RDMSTATE_H_
#define AP_PSM_APP_RDMSTATE_H_
...
namespace ap_psm_app
{
  ...
  public:
    ...
    RDMState() :
      value(static_cast< underlying_type >(RDM_INACTIVE))
    {
    }

    RDMState(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    RDMState(const RDMState& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END RDMState(const underlying_type v) :
      value(v)
    {
    }
    ...
    RDMState& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(RDMState&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    RDMState& operator=(const RDMState& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
