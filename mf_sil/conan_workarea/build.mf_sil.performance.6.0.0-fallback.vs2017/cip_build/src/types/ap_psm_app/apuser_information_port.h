...
#ifndef AP_PSM_APP_APUSER_INFORMATION_PORT_H_
#define AP_PSM_APP_APUSER_INFORMATION_PORT_H_
...
namespace ap_psm_app
{
  ...
  struct APUserInformationPort
  {
    ...
    MaxSpeed10KPHwarning maxSpeed10KPHwarning_nu;
    ...
    GarageParking garageParking_nu;
    ...
    HMIMessage generalUserInformation_nu;
    ...
    HUIntrPauseCondition apaIntrPauseCondition[15];
  ...
  inline ::ap_psm_app::APUserInformationPort createAPUserInformationPort()
  {
    APUserInformationPort m;
    (void)::eco::memset(&m, 0U, sizeof(APUserInformationPort));
...
namespace eco
{
  ...
  template<>
  inline ::ap_psm_app::APUserInformationPort create_default()
  {
      return ::ap_psm_app::createAPUserInformationPort();
  }
}


#endif // AP_PSM_APP_APUSER_INFORMATION_PORT_H_
