...
namespace ecu_ctrl
{
  ...
  public:
    ...
    EcuState() :
      value(static_cast< underlying_type >(ECU_STATE_INIT))
    {
    }

    EcuState(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    EcuState(const EcuState& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END EcuState(const underlying_type v) :
      value(v)
    {
    }
    ...
    EcuState& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(EcuState&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    EcuState& operator=(const EcuState& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
