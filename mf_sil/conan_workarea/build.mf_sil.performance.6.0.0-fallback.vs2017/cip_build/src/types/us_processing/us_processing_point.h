...
#ifndef US_PROCESSING_US_PROCESSING_POINT_H_
#define US_PROCESSING_US_PROCESSING_POINT_H_
...
namespace us_processing
{
  ...
  inline ::us_processing::UsProcessingPoint createUsProcessingPoint()
  {
    UsProcessingPoint m;
    (void)::eco::memset(&m, 0U, sizeof(UsProcessingPoint));
    return m;
  }
...
namespace eco
{
  ...
  template<>
  inline ::us_processing::UsProcessingPoint create_default()
  {
      return ::us_processing::createUsProcessingPoint();
  }
}


#endif // US_PROCESSING_US_PROCESSING_POINT_H_
