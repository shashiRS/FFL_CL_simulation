...
namespace us_processing
{
  ...
  public:
    ...
    UsProcessingObjectType() :
      value(static_cast< underlying_type >(US_PROCESSING_OBJ_TYPE_UNKOWN))
    {
    }

    UsProcessingObjectType(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    UsProcessingObjectType(const UsProcessingObjectType& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END UsProcessingObjectType(const underlying_type v) :
      value(v)
    {
    }
    ...
    UsProcessingObjectType& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(UsProcessingObjectType&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    UsProcessingObjectType& operator=(const UsProcessingObjectType& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
