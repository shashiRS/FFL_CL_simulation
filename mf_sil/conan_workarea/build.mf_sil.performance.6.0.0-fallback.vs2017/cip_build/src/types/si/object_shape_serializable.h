...
namespace si
{
  ...
  inline ::si::ObjectShapeSerializable createObjectShapeSerializable()
  {
    ObjectShapeSerializable m;
    (void)::eco::memset(&m, 0U, sizeof(ObjectShapeSerializable));
    m.actualSize = 0U;
    {
...
namespace eco
{
  ...
  template<>
  inline ::si::ObjectShapeSerializable create_default()
  {
      return ::si::createObjectShapeSerializable();
  }
}
