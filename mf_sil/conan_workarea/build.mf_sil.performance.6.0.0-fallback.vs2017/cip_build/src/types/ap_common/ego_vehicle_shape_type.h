...
namespace ap_common
{
  ...
  public:
    ...
    EgoVehicleShapeType() :
      value(static_cast< underlying_type >(EGO_VEH_SHAPE_STANDARD))
    {
    }

    EgoVehicleShapeType(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    EgoVehicleShapeType(const EgoVehicleShapeType& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END EgoVehicleShapeType(const underlying_type v) :
      value(v)
    {
    }
    ...
    EgoVehicleShapeType& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(EgoVehicleShapeType&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    EgoVehicleShapeType& operator=(const EgoVehicleShapeType& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
