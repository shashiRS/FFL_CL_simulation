...
#ifndef AP_COMMON_FC_TRJPLA_SYS_FUNC_PARAMS_H_
#define AP_COMMON_FC_TRJPLA_SYS_FUNC_PARAMS_H_
...
namespace ap_common
{
  ...
  struct FC_TRJPLA_Sys_Func_Params
  {
    ...
    TrafficSide AP_G_TRAFFIC_SIDE_NU;
  ...
  inline ::ap_common::FC_TRJPLA_Sys_Func_Params createFC_TRJPLA_Sys_Func_Params()
  {
    FC_TRJPLA_Sys_Func_Params m;
    (void)::eco::memset(&m, 0U, sizeof(FC_TRJPLA_Sys_Func_Params));
...
namespace eco
{
  ...
  template<>
  inline ::ap_common::FC_TRJPLA_Sys_Func_Params create_default()
  {
      return ::ap_common::createFC_TRJPLA_Sys_Func_Params();
  }
}


#endif // AP_COMMON_FC_TRJPLA_SYS_FUNC_PARAMS_H_
