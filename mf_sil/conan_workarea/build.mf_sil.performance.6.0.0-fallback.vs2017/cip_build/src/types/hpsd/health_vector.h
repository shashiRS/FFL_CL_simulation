...
#ifndef HPSD_HEALTH_VECTOR_H_
#define HPSD_HEALTH_VECTOR_H_
...
namespace hpsd
{
  ...
  inline ::hpsd::HealthVector createHealthVector()
  {
    HealthVector m;
    (void)::eco::memset(&m, 0U, sizeof(HealthVector));
    return m;
  }
...
namespace eco
{
  ...
  template<>
  inline ::hpsd::HealthVector create_default()
  {
      return ::hpsd::createHealthVector();
  }
}


#endif // HPSD_HEALTH_VECTOR_H_
