...
namespace ap_tp
{
  ...
  inline ::ap_tp::FC_TAPOSD_Params createFC_TAPOSD_Params()
  {
    FC_TAPOSD_Params m;
    (void)::eco::memset(&m, 0U, sizeof(FC_TAPOSD_Params));
...
namespace eco
{
  ...
  template<>
  inline ::ap_tp::FC_TAPOSD_Params create_default()
  {
      return ::ap_tp::createFC_TAPOSD_Params();
  }
}
