...
namespace ap_tp
{
  ...
  public:
    ...
    VLPositioningApproach() :
      value(static_cast< underlying_type >(ALIGN_TO_FRONT_VL_PT))
    {
    }

    VLPositioningApproach(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    VLPositioningApproach(const VLPositioningApproach& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END VLPositioningApproach(const underlying_type v) :
      value(v)
    {
    }
    ...
    VLPositioningApproach& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(VLPositioningApproach&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    VLPositioningApproach& operator=(const VLPositioningApproach& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
