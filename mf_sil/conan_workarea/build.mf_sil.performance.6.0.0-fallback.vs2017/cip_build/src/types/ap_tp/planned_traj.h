...
namespace ap_tp
{
  ...
  inline ::ap_tp::PlannedTraj createPlannedTraj()
  {
    PlannedTraj m;
    (void)::eco::memset(&m, 0U, sizeof(PlannedTraj));
    return m;
  }
...
namespace eco
{
  ...
  template<>
  inline ::ap_tp::PlannedTraj create_default()
  {
      return ::ap_tp::createPlannedTraj();
  }
}
