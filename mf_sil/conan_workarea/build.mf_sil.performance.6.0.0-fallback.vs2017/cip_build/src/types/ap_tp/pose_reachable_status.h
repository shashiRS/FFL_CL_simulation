...
namespace ap_tp
{
  ...
  public:
    ...
    PoseReachableStatus() :
      value(static_cast< underlying_type >(TP_NOT_VALID))
    {
    }

    PoseReachableStatus(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    PoseReachableStatus(const PoseReachableStatus& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END PoseReachableStatus(const underlying_type v) :
      value(v)
    {
    }
    ...
    PoseReachableStatus& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(PoseReachableStatus&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    PoseReachableStatus& operator=(const PoseReachableStatus& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
