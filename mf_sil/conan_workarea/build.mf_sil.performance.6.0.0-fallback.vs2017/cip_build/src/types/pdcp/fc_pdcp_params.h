...
namespace pdcp
{
  ...
  inline ::pdcp::FC_PDCP_Params createFC_PDCP_Params()
  {
    FC_PDCP_Params m;
    (void)::eco::memset(&m, 0U, sizeof(FC_PDCP_Params));
...
namespace eco
{
  ...
  template<>
  inline ::pdcp::FC_PDCP_Params create_default()
  {
      return ::pdcp::createFC_PDCP_Params();
  }
}
