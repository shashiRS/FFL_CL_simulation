...
namespace ap_trjctl
{
  ...
  class MF_CONTROL_te_LongCtrlMode
  {
  public:
    ...
    MF_CONTROL_te_LongCtrlMode() :
      value(static_cast< underlying_type >(MF_LONG_CTRL_MODE_NO_CONTROL))
    {
    }

    MF_CONTROL_te_LongCtrlMode(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    MF_CONTROL_te_LongCtrlMode(const MF_CONTROL_te_LongCtrlMode& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END MF_CONTROL_te_LongCtrlMode(const underlying_type v) :
      value(v)
    {
    }
    ...
    MF_CONTROL_te_LongCtrlMode& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(MF_CONTROL_te_LongCtrlMode&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    MF_CONTROL_te_LongCtrlMode& operator=(const MF_CONTROL_te_LongCtrlMode& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
