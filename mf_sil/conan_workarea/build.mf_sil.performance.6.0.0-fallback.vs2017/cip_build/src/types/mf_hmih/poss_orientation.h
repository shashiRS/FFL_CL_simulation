...
namespace mf_hmih
{
  ...
  public:
    ...
    PossOrientation() :
      value(static_cast< underlying_type >(POSS_ORI_CERTAIN))
    {
    }

    PossOrientation(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    PossOrientation(const PossOrientation& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END PossOrientation(const underlying_type v) :
      value(v)
    {
    }
    ...
    PossOrientation& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(PossOrientation&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    PossOrientation& operator=(const PossOrientation& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
