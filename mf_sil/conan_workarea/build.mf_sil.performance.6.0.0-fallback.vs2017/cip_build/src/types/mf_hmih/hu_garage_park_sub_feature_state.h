...
namespace mf_hmih
{
  ...
  class HuGarageParkSubFeatureState
  {
  public:
    ...
    HuGarageParkSubFeatureState() :
      value(static_cast< underlying_type >(UNUSED))
    {
    }

    HuGarageParkSubFeatureState(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    HuGarageParkSubFeatureState(const HuGarageParkSubFeatureState& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END HuGarageParkSubFeatureState(const underlying_type v) :
      value(v)
    {
    }
    ...
    HuGarageParkSubFeatureState& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(HuGarageParkSubFeatureState&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    HuGarageParkSubFeatureState& operator=(const HuGarageParkSubFeatureState& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
