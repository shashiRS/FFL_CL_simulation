...
namespace mf_hmih
{
  ...
  inline ::mf_hmih::VisuHMIData createVisuHMIData()
  {
    VisuHMIData m;
    (void)::eco::memset(&m, 0U, sizeof(VisuHMIData));
    return m;
  }
...
namespace eco
{
  ...
  template<>
  inline ::mf_hmih::VisuHMIData create_default()
  {
      return ::mf_hmih::createVisuHMIData();
  }
}
