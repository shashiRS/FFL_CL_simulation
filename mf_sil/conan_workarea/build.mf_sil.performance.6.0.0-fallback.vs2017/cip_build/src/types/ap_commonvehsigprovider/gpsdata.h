...
namespace ap_commonvehsigprovider
{
  ...
  inline ::ap_commonvehsigprovider::GPSData createGPSData()
  {
    GPSData m;
    (void)::eco::memset(&m, 0U, sizeof(GPSData));
    return m;
  }
...
namespace eco
{
  ...
  template<>
  inline ::ap_commonvehsigprovider::GPSData create_default()
  {
      return ::ap_commonvehsigprovider::createGPSData();
  }
}
