...
namespace ap_commonvehsigprovider
{
  ...
  public:
    ...
    WheelDrivingDirection() :
      value(static_cast< underlying_type >(WHEEL_DIRECTION_REVERSE))
    {
    }

    WheelDrivingDirection(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    WheelDrivingDirection(const WheelDrivingDirection& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END WheelDrivingDirection(const underlying_type v) :
      value(v)
    {
    }
    ...
    WheelDrivingDirection& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(WheelDrivingDirection&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    WheelDrivingDirection& operator=(const WheelDrivingDirection& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
