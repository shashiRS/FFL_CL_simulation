...
namespace ap_commonvehsigprovider
{
  ...
  inline ::ap_commonvehsigprovider::EngineCtrlStatusPort createEngineCtrlStatusPort()
  {
    EngineCtrlStatusPort m;
    (void)::eco::memset(&m, 0U, sizeof(EngineCtrlStatusPort));
...
namespace eco
{
  ...
  template<>
  inline ::ap_commonvehsigprovider::EngineCtrlStatusPort create_default()
  {
      return ::ap_commonvehsigprovider::createEngineCtrlStatusPort();
  }
}
