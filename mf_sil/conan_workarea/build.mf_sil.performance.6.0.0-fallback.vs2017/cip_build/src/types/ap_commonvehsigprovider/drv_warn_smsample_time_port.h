...
namespace ap_commonvehsigprovider
{
  ...
  inline ::ap_commonvehsigprovider::DrvWarnSMSampleTimePort createDrvWarnSMSampleTimePort()
  {
    DrvWarnSMSampleTimePort m;
    (void)::eco::memset(&m, 0U, sizeof(DrvWarnSMSampleTimePort));
...
namespace eco
{
  ...
  template<>
  inline ::ap_commonvehsigprovider::DrvWarnSMSampleTimePort create_default()
  {
      return ::ap_commonvehsigprovider::createDrvWarnSMSampleTimePort();
  }
}
