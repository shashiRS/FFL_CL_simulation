...
namespace ap_vehstatesigprovider
{
  ...
  inline ::ap_vehstatesigprovider::ChassisAxleHeightPort createChassisAxleHeightPort()
  {
    ChassisAxleHeightPort m;
    (void)::eco::memset(&m, 0U, sizeof(ChassisAxleHeightPort));
...
namespace eco
{
  ...
  template<>
  inline ::ap_vehstatesigprovider::ChassisAxleHeightPort create_default()
  {
      return ::ap_vehstatesigprovider::createChassisAxleHeightPort();
  }
}
