...
namespace mf_drvwarnsm
{
  ...
  public:
    ...
    WHPState() :
      value(static_cast< underlying_type >(WHP_INIT))
    {
    }

    WHPState(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    WHPState(const WHPState& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END WHPState(const underlying_type v) :
      value(v)
    {
    }
    ...
    WHPState& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(WHPState&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    WHPState& operator=(const WHPState& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
