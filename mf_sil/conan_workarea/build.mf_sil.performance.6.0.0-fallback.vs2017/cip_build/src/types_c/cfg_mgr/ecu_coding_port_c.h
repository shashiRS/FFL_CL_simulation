...
#ifndef CFG_MGR_ECU_CODING_PORT_C_H_
#define CFG_MGR_ECU_CODING_PORT_C_H_
...
typedef struct
{
    ...
    CFG_MGR_EcuCodingState codingState_e;
    boolean isUsSupported;
    uint8 numOfUsSensors;
    CFG_MGR_UsSensorDegradationType UsDegradationMode_e;
...
} CFG_MGR_EcuCodingPort;

inline CFG_MGR_EcuCodingPort create_CFG_MGR_EcuCodingPort(void)
{
  CFG_MGR_EcuCodingPort m;
  (void) ECO_memset (&m, 0, sizeof(m));
  return m;
}

#endif // CFG_MGR_ECU_CODING_PORT_C_H_
