...
#ifndef LSM_VEDODO_ODO_ESTIMATION_C_H_
#define LSM_VEDODO_ODO_ESTIMATION_C_H_
...
typedef struct
{
    ...
    LSM_VEDODO_MotionState motionStatus_nu;
    ///@range{-1,1}
    ///The vehicle current driving direction.
    LSM_VEDODO_Direction drivingDirection_nu;
} LSM_VEDODO_OdoEstimation;

inline LSM_VEDODO_OdoEstimation create_LSM_VEDODO_OdoEstimation(void)
{
  LSM_VEDODO_OdoEstimation m;
  (void) ECO_memset (&m, 0, sizeof(m));
  m.sSigHeader = create_ECO_SignalHeader();
  return m;
}

#endif // LSM_VEDODO_ODO_ESTIMATION_C_H_
