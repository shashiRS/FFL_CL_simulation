...
#ifndef US_EM_STATIC_OBJECT_SERIALIZABLE_C_H_
#define US_EM_STATIC_OBJECT_SERIALIZABLE_C_H_
...
typedef struct
{
    ...
    US_EM_StaticObjShapeSerializable objShape_m;
    ///@range{0,5}
    ///@unit{nu}
    ///Height class of the object
    US_EM_StaticObjHeightType objHeightClass_nu;
    ///@unit{Percent}
    ///@range{0,100}
    ///Confidence in the object height classification
    uint8 objHeightClassConfidence_perc;
} US_EM_StaticObjectSerializable;

inline US_EM_StaticObjectSerializable create_US_EM_StaticObjectSerializable(void)
{
  US_EM_StaticObjectSerializable m;
  (void) ECO_memset (&m, 0, sizeof(m));
  m.refObjID_nu = 65535U;
  m.objShape_m = create_US_EM_StaticObjShapeSerializable();
  return m;
}

#endif // US_EM_STATIC_OBJECT_SERIALIZABLE_C_H_
