...
#ifndef SI_EGO_MOTION_PORT_C_H_
#define SI_EGO_MOTION_PORT_C_H_
...
typedef struct
{
    ...
    SI_SIMotionState motionState_nu;
    ///@unit{Radian}
...
inline SI_EgoMotionPort create_SI_EgoMotionPort(void)
{
  SI_EgoMotionPort m;
