...
#ifndef MF_WHLPROTECTPROC_FC_MF_WHL_PROTECT_PROC_PARAMS_C_H_
#define MF_WHLPROTECTPROC_FC_MF_WHL_PROTECT_PROC_PARAMS_C_H_
...
} MF_WHLPROTECTPROC_FC_MF_WhlProtectProc_Params;

inline MF_WHLPROTECTPROC_FC_MF_WhlProtectProc_Params create_MF_WHLPROTECTPROC_FC_MF_WhlProtectProc_Params(void)
{
  MF_WHLPROTECTPROC_FC_MF_WhlProtectProc_Params m;
  (void) ECO_memset (&m, 0, sizeof(m));
  m.sSigHeader = create_ECO_SignalHeader();
  return m;
}

#endif // MF_WHLPROTECTPROC_FC_MF_WHL_PROTECT_PROC_PARAMS_C_H_
