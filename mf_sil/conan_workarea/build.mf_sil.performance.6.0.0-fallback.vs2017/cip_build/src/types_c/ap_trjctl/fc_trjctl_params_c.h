...
#ifndef AP_TRJCTL_FC_TRJCTL_PARAMS_C_H_
#define AP_TRJCTL_FC_TRJCTL_PARAMS_C_H_
...
typedef struct
{
    ...
    AP_TRJCTL_FC_TRJCTL_Vehicle_Params vehicleParams;
    ///Nested struct for sys func params section
    AP_TRJCTL_FC_TRJCTL_Sys_Func_Params sysFuncParams;
} AP_TRJCTL_FC_TRJCTL_Params;

inline AP_TRJCTL_FC_TRJCTL_Params create_AP_TRJCTL_FC_TRJCTL_Params(void)
{
  AP_TRJCTL_FC_TRJCTL_Params m;
  (void) ECO_memset (&m, 0, sizeof(m));
  m.sSigHeader = create_ECO_SignalHeader();
  m.vehicleParams = create_AP_TRJCTL_FC_TRJCTL_Vehicle_Params();
  m.sysFuncParams = create_AP_TRJCTL_FC_TRJCTL_Sys_Func_Params();
  return m;
}

#endif // AP_TRJCTL_FC_TRJCTL_PARAMS_C_H_
