...
#ifndef MF_DRVWARNSM_FC_DRV_WARN_SM_PARAMS_C_H_
#define MF_DRVWARNSM_FC_DRV_WARN_SM_PARAMS_C_H_
...
} MF_DRVWARNSM_FC_DrvWarnSM_Params;

inline MF_DRVWARNSM_FC_DrvWarnSM_Params create_MF_DRVWARNSM_FC_DrvWarnSM_Params(void)
{
  MF_DRVWARNSM_FC_DrvWarnSM_Params m;
  (void) ECO_memset (&m, 0, sizeof(m));
  m.sSigHeader = create_ECO_SignalHeader();
  return m;
}

#endif // MF_DRVWARNSM_FC_DRV_WARN_SM_PARAMS_C_H_
