...
#ifndef AP_TP_SELECTED_POSE_DATA_C_H_
#define AP_TP_SELECTED_POSE_DATA_C_H_
...
typedef struct
{
    ...
    AP_TP_PoseSelectionStatus selectionStatus;
    ///@range{0,3}
    ...
    AP_TP_PoseReachedStatus reachedStatus;
    ///@range{0,64}
    ///@unit{m}
    ///None @min: 0 @max: 64 @unit: m
    float32 distanceToStart_m;
} AP_TP_SelectedPoseData;

inline AP_TP_SelectedPoseData create_AP_TP_SelectedPoseData(void)
{
  AP_TP_SelectedPoseData m;
  (void) ECO_memset (&m, 0, sizeof(m));
  return m;
}

#endif // AP_TP_SELECTED_POSE_DATA_C_H_
