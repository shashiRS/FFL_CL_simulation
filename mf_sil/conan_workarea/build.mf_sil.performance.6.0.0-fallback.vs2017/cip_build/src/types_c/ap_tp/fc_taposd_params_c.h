...
#ifndef AP_TP_FC_TAPOSD_PARAMS_C_H_
#define AP_TP_FC_TAPOSD_PARAMS_C_H_
...
typedef struct
{
    ...
    AP_TP_PosDefApproach AP_T_POS_DEF_APPROACH;
...
} AP_TP_FC_TAPOSD_Params;

inline AP_TP_FC_TAPOSD_Params create_AP_TP_FC_TAPOSD_Params(void)
{
  AP_TP_FC_TAPOSD_Params m;
  (void) ECO_memset (&m, 0, sizeof(m));
  m.sSigHeader = create_ECO_SignalHeader();
  return m;
}

#endif // AP_TP_FC_TAPOSD_PARAMS_C_H_
