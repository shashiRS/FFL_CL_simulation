...
#ifndef AP_TP_FC_TRJPLA_PARAMS_C_H_
#define AP_TP_FC_TRJPLA_PARAMS_C_H_
...
typedef struct
{
    ...
    AP_TP_FC_TAPOSD_Params taposdParams;
    ///Nested struct for vehicle params section
    AP_COMMON_FC_TRJPLA_Vehicle_Params vehicleParams;
    ///Nested struct for sys func params section
    AP_COMMON_FC_TRJPLA_Sys_Func_Params sysFuncParams;
...
} AP_TP_FC_TRJPLA_Params;

inline AP_TP_FC_TRJPLA_Params create_AP_TP_FC_TRJPLA_Params(void)
{
  AP_TP_FC_TRJPLA_Params m;
  (void) ECO_memset (&m, 0, sizeof(m));
  m.sSigHeader = create_ECO_SignalHeader();
  m.taposdParams = create_AP_TP_FC_TAPOSD_Params();
  m.vehicleParams = create_AP_COMMON_FC_TRJPLA_Vehicle_Params();
  m.sysFuncParams = create_AP_COMMON_FC_TRJPLA_Sys_Func_Params();
  return m;
}

#endif // AP_TP_FC_TRJPLA_PARAMS_C_H_
