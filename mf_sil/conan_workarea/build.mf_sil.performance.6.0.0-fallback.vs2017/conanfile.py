...
class mf_silPackage(ConanFile):
    ...
    # -- conan attributes
    name = "mf_sil.entry" # we use the binary key as conan package name
    version = "6.0.0-fallback"
    license = "ADAS GmbH; all rights reserved"
    url = "git@github-am.geo.conti.de:ADAS/mf_sil.git"
    ...
    CIP_BUILD_SYSTEM_VERSION = "4.29.0"
    ...
    cip_package_name = "mf_sil"

    variant_to_build = "entry"
    build_platform = "vs2017_debug"
    target_platform = "vs2017_debug"

    # define options for variant
    variant_options = {'DEPENDENCY_EXPORT_ONLY': {'default': False, 'type': 'boolean', 'value': False}, 'LOCAL_BUILD': {'default': False, 'type': 'boolean', 'value': False}, 'MOCO': {'default': False, 'type': 'boolean', 'value': False}, 'PERFORMANCE': {'default': False, 'type': 'boolean', 'value': False}, 'ULTRASONIC_ONLY': {'default': False, 'type': 'boolean', 'value': True}, 'USE_HMI': {'default': False, 'type': 'boolean', 'value': False}}
    ...
    cip_groups_to_build = ['PACKAGE_INFO', 'TARGET_COMPONENT']
    cip_groups_to_install = ['PACKAGE_INFO', 'TARGET_COMPONENT', '__BRICKS_IMPLICIT_DEPENDENCIES']
    ...
    def __bricks_init(self):
        ...
        if not hasattr(self, '__cip_binary_dependencies'):
            ...
            binary_dependencies = {'vs2017_debug': {'deploy': ['appdemo_drvwarnsm.cus_only', 'appdemo_drvwarnsm_types.generic', 'appdemo_hmih.cus_only', 'appdemo_hmih_types.cus_only', 'appdemo_parksm.cus_only', 'appdemo_parksm_types.cus_only', 'appdemo_tonh.cus_only', 'appdemo_tonh_types.generic', 'avga_swc.cus_only', 'avga_swc_types.generic', 'dmc_types.generic', 'eco.generic', 'geoml.generic', 'mf_common.cus_only', 'mf_common_types.cus_only', 'mf_drvwarnsm_core.cus_only', 'mf_drvwarnsm_core_types.cus_only', 'mf_lsca.cus_only', 'mf_lsca_types.cus_only', 'mf_lvmd_types.generic', 'mf_manager.cus_only', 'mf_manager_types.generic', 'mf_memory_parking_types.generic', 'mf_parksm_core.cus_only', 'mf_parksm_core_types.generic', 'mf_pdwarnproc.cus_only', 'mf_pdwarnproc_types.generic', 'mf_plot.cus_only', 'mf_taposd.cus_only', 'mf_trjctl.cus_only', 'mf_trjctl_types.generic', 'mf_trjpla.cus_only', 'mf_trjpla_types.cus_only', 'mf_vedodo.cus_only', 'mf_vedodo_types.generic', 'mf_whlprotectproc.cus_only', 'mf_whlprotectproc_types.generic', 'parking_hmi_types.generic', 'plp_hpsd_types.generic', 'plp_log.generic', 'relocalization_types.generic', 'si_core.cus_only', 'si_types.cus_only', 'tce.cus_only', 'tce_types.generic', 'us_drv_types.generic', 'us_em.generic', 'us_em_types.generic', 'us_processing.cus_only', 'us_processing_types.cus_only', 'vehicle_types.generic', 'viewcontroller_types.cus_only'], 'production': ['adas_platforms.generic', 'appdemo_drvwarnsm.cus_only', 'appdemo_drvwarnsm_types.generic', 'appdemo_hmih.cus_only', 'appdemo_hmih_types.cus_only', 'appdemo_parksm.cus_only', 'appdemo_parksm_types.cus_only', 'appdemo_tonh.cus_only', 'appdemo_tonh_types.generic', 'appl_srv_layer_types.generic', 'avga_swc.cus_only', 'avga_swc_types.generic', 'carmaker_build_dep', 'cmake', 'dmc_types.generic', 'eco.generic', 'geoml.generic', 'jsoncpp.generic', 'make', 'mf_common.cus_only', 'mf_common_types.cus_only', 'mf_drvwarnsm_core.cus_only', 'mf_drvwarnsm_core_types.cus_only', 'mf_lsca.cus_only', 'mf_lsca_types.cus_only', 'mf_lvmd_types.generic', 'mf_manager.cus_only', 'mf_manager_types.generic', 'mf_memory_parking_types.generic', 'mf_parksm_core.cus_only', 'mf_parksm_core_types.generic', 'mf_pdwarnproc.cus_only', 'mf_pdwarnproc_types.generic', 'mf_plot.cus_only', 'mf_taposd.cus_only', 'mf_trjctl.cus_only', 'mf_trjctl_types.generic', 'mf_trjpla.cus_only', 'mf_trjpla_types.cus_only', 'mf_vedodo.cus_only', 'mf_vedodo_types.generic', 'mf_whlprotectproc.cus_only', 'mf_whlprotectproc_types.generic', 'parking_hmi_types.generic', 'plp_hpsd_types.generic', 'plp_log.generic', 'protobuf', 'relocalization_types.generic', 'si_core.cus_only', 'si_types.cus_only', 'tce.cus_only', 'tce_types.generic', 'us_drv_types.generic', 'us_em.generic', 'us_em_types.generic', 'us_processing.cus_only', 'us_processing_types.cus_only', 'vehicle_types.generic', 'viewcontroller_types.cus_only'], 'build': ['adas_platforms.generic', 'appl_srv_layer_types.generic', 'bricks_cmake_checks.__system', 'bricks_cmake_core.__system', 'bricks_cmake_groups.__system', 'carmaker_build_dep', 'cip_build_system_platforms.__system', 'cmake', 'jsoncpp.generic', 'make', 'protobuf'], 'system': ['bricks_cmake_checks.__system', 'bricks_cmake_core.__system', 'bricks_cmake_groups.__system'], 'platform': 'cip_build_system_platforms.__system', 'all': ['adas_platforms.generic', 'appdemo_drvwarnsm.cus_only', 'appdemo_drvwarnsm_types.generic', 'appdemo_hmih.cus_only', 'appdemo_hmih_types.cus_only', 'appdemo_parksm.cus_only', 'appdemo_parksm_types.cus_only', 'appdemo_tonh.cus_only', 'appdemo_tonh_types.generic', 'appl_srv_layer_types.generic', 'avga_swc.cus_only', 'avga_swc_types.generic', 'bricks_cmake_checks.__system', 'bricks_cmake_core.__system', 'bricks_cmake_groups.__system', 'carmaker_build_dep', 'cip_build_system_platforms.__system', 'cmake', 'dmc_types.generic', 'eco.generic', 'geoml.generic', 'jsoncpp.generic', 'make', 'mf_common.cus_only', 'mf_common_types.cus_only', 'mf_drvwarnsm_core.cus_only', 'mf_drvwarnsm_core_types.cus_only', 'mf_lsca.cus_only', 'mf_lsca_types.cus_only', 'mf_lvmd_types.generic', 'mf_manager.cus_only', 'mf_manager_types.generic', 'mf_memory_parking_types.generic', 'mf_parksm_core.cus_only', 'mf_parksm_core_types.generic', 'mf_pdwarnproc.cus_only', 'mf_pdwarnproc_types.generic', 'mf_plot.cus_only', 'mf_taposd.cus_only', 'mf_trjctl.cus_only', 'mf_trjctl_types.generic', 'mf_trjpla.cus_only', 'mf_trjpla_types.cus_only', 'mf_vedodo.cus_only', 'mf_vedodo_types.generic', 'mf_whlprotectproc.cus_only', 'mf_whlprotectproc_types.generic', 'parking_hmi_types.generic', 'plp_hpsd_types.generic', 'plp_log.generic', 'protobuf', 'relocalization_types.generic', 'si_core.cus_only', 'si_types.cus_only', 'tce.cus_only', 'tce_types.generic', 'us_drv_types.generic', 'us_em.generic', 'us_em_types.generic', 'us_processing.cus_only', 'us_processing_types.cus_only', 'vehicle_types.generic', 'viewcontroller_types.cus_only']}, 'ubuntu_20_04_x86_64': {'deploy': ['appdemo_drvwarnsm.cus_only', 'appdemo_drvwarnsm_types.generic', 'appdemo_hmih.cus_only', 'appdemo_hmih_types.cus_only', 'appdemo_parksm.cus_only', 'appdemo_parksm_types.cus_only', 'appdemo_tonh.cus_only', 'appdemo_tonh_types.generic', 'avga_swc.cus_only', 'avga_swc_types.generic', 'dmc_types.generic', 'eco.generic', 'geoml.generic', 'jsoncpp.generic', 'mf_common.cus_only', 'mf_common_types.cus_only', 'mf_drvwarnsm_core.cus_only', 'mf_drvwarnsm_core_types.cus_only', 'mf_lsca.cus_only', 'mf_lsca_types.cus_only', 'mf_lvmd_types.generic', 'mf_manager.cus_only', 'mf_manager_types.generic', 'mf_memory_parking_types.generic', 'mf_parksm_core.cus_only', 'mf_parksm_core_types.generic', 'mf_pdwarnproc.cus_only', 'mf_pdwarnproc_types.generic', 'mf_taposd.cus_only', 'mf_trjctl.cus_only', 'mf_trjctl_types.generic', 'mf_trjpla.cus_only', 'mf_trjpla_types.cus_only', 'mf_vedodo.cus_only', 'mf_vedodo_types.generic', 'mf_whlprotectproc.cus_only', 'mf_whlprotectproc_types.generic', 'parking_hmi_types.generic', 'plp_hpsd_types.generic', 'plp_log.generic', 'relocalization_types.generic', 'si_core.cus_only', 'si_types.cus_only', 'tce.cus_only', 'tce_types.generic', 'us_drv_types.generic', 'us_em.generic', 'us_em_types.generic', 'us_processing.cus_only', 'us_processing_types.cus_only', 'vehicle_types.generic', 'viewcontroller_types.cus_only'], 'production': ['adas_platforms.generic', 'appdemo_drvwarnsm.cus_only', 'appdemo_drvwarnsm_types.generic', 'appdemo_hmih.cus_only', 'appdemo_hmih_types.cus_only', 'appdemo_parksm.cus_only', 'appdemo_parksm_types.cus_only', 'appdemo_tonh.cus_only', 'appdemo_tonh_types.generic', 'appl_srv_layer_types.generic', 'avga_swc.cus_only', 'avga_swc_types.generic', 'cmake', 'dmc_types.generic', 'eco.generic', 'geoml.generic', 'jsoncpp.generic', 'make', 'mf_common.cus_only', 'mf_common_types.cus_only', 'mf_drvwarnsm_core.cus_only', 'mf_drvwarnsm_core_types.cus_only', 'mf_lsca.cus_only', 'mf_lsca_types.cus_only', 'mf_lvmd_types.generic', 'mf_manager.cus_only', 'mf_manager_types.generic', 'mf_memory_parking_types.generic', 'mf_parksm_core.cus_only', 'mf_parksm_core_types.generic', 'mf_pdwarnproc.cus_only', 'mf_pdwarnproc_types.generic', 'mf_taposd.cus_only', 'mf_trjctl.cus_only', 'mf_trjctl_types.generic', 'mf_trjpla.cus_only', 'mf_trjpla_types.cus_only', 'mf_vedodo.cus_only', 'mf_vedodo_types.generic', 'mf_whlprotectproc.cus_only', 'mf_whlprotectproc_types.generic', 'parking_hmi_types.generic', 'plp_hpsd_types.generic', 'plp_log.generic', 'relocalization_types.generic', 'si_core.cus_only', 'si_types.cus_only', 'tce.cus_only', 'tce_types.generic', 'us_drv_types.generic', 'us_em.generic', 'us_em_types.generic', 'us_processing.cus_only', 'us_processing_types.cus_only', 'vehicle_types.generic', 'viewcontroller_types.cus_only'], 'build': ['adas_platforms.generic', 'appl_srv_layer_types.generic', 'bricks_cmake_checks.__system', 'bricks_cmake_core.__system', 'bricks_cmake_groups.__system', 'cip_build_system_platforms.__system', 'cmake', 'make'], 'system': ['bricks_cmake_checks.__system', 'bricks_cmake_core.__system', 'bricks_cmake_groups.__system'], 'platform': 'cip_build_system_platforms.__system', 'all': ['adas_platforms.generic', 'appdemo_drvwarnsm.cus_only', 'appdemo_drvwarnsm_types.generic', 'appdemo_hmih.cus_only', 'appdemo_hmih_types.cus_only', 'appdemo_parksm.cus_only', 'appdemo_parksm_types.cus_only', 'appdemo_tonh.cus_only', 'appdemo_tonh_types.generic', 'appl_srv_layer_types.generic', 'avga_swc.cus_only', 'avga_swc_types.generic', 'bricks_cmake_checks.__system', 'bricks_cmake_core.__system', 'bricks_cmake_groups.__system', 'cip_build_system_platforms.__system', 'cmake', 'dmc_types.generic', 'eco.generic', 'geoml.generic', 'jsoncpp.generic', 'make', 'mf_common.cus_only', 'mf_common_types.cus_only', 'mf_drvwarnsm_core.cus_only', 'mf_drvwarnsm_core_types.cus_only', 'mf_lsca.cus_only', 'mf_lsca_types.cus_only', 'mf_lvmd_types.generic', 'mf_manager.cus_only', 'mf_manager_types.generic', 'mf_memory_parking_types.generic', 'mf_parksm_core.cus_only', 'mf_parksm_core_types.generic', 'mf_pdwarnproc.cus_only', 'mf_pdwarnproc_types.generic', 'mf_taposd.cus_only', 'mf_trjctl.cus_only', 'mf_trjctl_types.generic', 'mf_trjpla.cus_only', 'mf_trjpla_types.cus_only', 'mf_vedodo.cus_only', 'mf_vedodo_types.generic', 'mf_whlprotectproc.cus_only', 'mf_whlprotectproc_types.generic', 'parking_hmi_types.generic', 'plp_hpsd_types.generic', 'plp_log.generic', 'relocalization_types.generic', 'si_core.cus_only', 'si_types.cus_only', 'tce.cus_only', 'tce_types.generic', 'us_drv_types.generic', 'us_em.generic', 'us_em_types.generic', 'us_processing.cus_only', 'us_processing_types.cus_only', 'vehicle_types.generic', 'viewcontroller_types.cus_only']}, 'ubuntu_20_04_x86_64-release': {'build': ['adas_platforms.generic', 'appl_srv_layer_types.generic', 'bricks_cmake_checks.__system', 'bricks_cmake_core.__system', 'bricks_cmake_groups.__system', 'cip_build_system_platforms.__system', 'cmake', 'make'], 'production': ['adas_platforms.generic', 'appdemo_drvwarnsm.cus_only', 'appdemo_drvwarnsm_types.generic', 'appdemo_hmih.cus_only', 'appdemo_hmih_types.cus_only', 'appdemo_parksm.cus_only', 'appdemo_parksm_types.cus_only', 'appdemo_tonh.cus_only', 'appdemo_tonh_types.generic', 'appl_srv_layer_types.generic', 'avga_swc.cus_only', 'avga_swc_types.generic', 'cmake', 'dmc_types.generic', 'eco.generic', 'geoml.generic', 'jsoncpp.generic', 'make', 'mf_common.cus_only', 'mf_common_types.cus_only', 'mf_drvwarnsm_core.cus_only', 'mf_drvwarnsm_core_types.cus_only', 'mf_lsca.cus_only', 'mf_lsca_types.cus_only', 'mf_lvmd_types.generic', 'mf_manager.cus_only', 'mf_manager_types.generic', 'mf_memory_parking_types.generic', 'mf_parksm_core.cus_only', 'mf_parksm_core_types.generic', 'mf_pdwarnproc.cus_only', 'mf_pdwarnproc_types.generic', 'mf_taposd.cus_only', 'mf_trjctl.cus_only', 'mf_trjctl_types.generic', 'mf_trjpla.cus_only', 'mf_trjpla_types.cus_only', 'mf_vedodo.cus_only', 'mf_vedodo_types.generic', 'mf_whlprotectproc.cus_only', 'mf_whlprotectproc_types.generic', 'parking_hmi_types.generic', 'plp_hpsd_types.generic', 'plp_log.generic', 'relocalization_types.generic', 'si_core.cus_only', 'si_types.cus_only', 'tce.cus_only', 'tce_types.generic', 'us_drv_types.generic', 'us_em.generic', 'us_em_types.generic', 'us_processing.cus_only', 'us_processing_types.cus_only', 'vehicle_types.generic', 'viewcontroller_types.cus_only'], 'system': ['bricks_cmake_checks.__system', 'bricks_cmake_core.__system', 'bricks_cmake_groups.__system'], 'platform': 'cip_build_system_platforms.__system', 'deploy': ['appdemo_drvwarnsm.cus_only', 'appdemo_drvwarnsm_types.generic', 'appdemo_hmih.cus_only', 'appdemo_hmih_types.cus_only', 'appdemo_parksm.cus_only', 'appdemo_parksm_types.cus_only', 'appdemo_tonh.cus_only', 'appdemo_tonh_types.generic', 'avga_swc.cus_only', 'avga_swc_types.generic', 'dmc_types.generic', 'eco.generic', 'geoml.generic', 'jsoncpp.generic', 'mf_common.cus_only', 'mf_common_types.cus_only', 'mf_drvwarnsm_core.cus_only', 'mf_drvwarnsm_core_types.cus_only', 'mf_lsca.cus_only', 'mf_lsca_types.cus_only', 'mf_lvmd_types.generic', 'mf_manager.cus_only', 'mf_manager_types.generic', 'mf_memory_parking_types.generic', 'mf_parksm_core.cus_only', 'mf_parksm_core_types.generic', 'mf_pdwarnproc.cus_only', 'mf_pdwarnproc_types.generic', 'mf_taposd.cus_only', 'mf_trjctl.cus_only', 'mf_trjctl_types.generic', 'mf_trjpla.cus_only', 'mf_trjpla_types.cus_only', 'mf_vedodo.cus_only', 'mf_vedodo_types.generic', 'mf_whlprotectproc.cus_only', 'mf_whlprotectproc_types.generic', 'parking_hmi_types.generic', 'plp_hpsd_types.generic', 'plp_log.generic', 'relocalization_types.generic', 'si_core.cus_only', 'si_types.cus_only', 'tce.cus_only', 'tce_types.generic', 'us_drv_types.generic', 'us_em.generic', 'us_em_types.generic', 'us_processing.cus_only', 'us_processing_types.cus_only', 'vehicle_types.generic', 'viewcontroller_types.cus_only'], 'all': ['adas_platforms.generic', 'appdemo_drvwarnsm.cus_only', 'appdemo_drvwarnsm_types.generic', 'appdemo_hmih.cus_only', 'appdemo_hmih_types.cus_only', 'appdemo_parksm.cus_only', 'appdemo_parksm_types.cus_only', 'appdemo_tonh.cus_only', 'appdemo_tonh_types.generic', 'appl_srv_layer_types.generic', 'avga_swc.cus_only', 'avga_swc_types.generic', 'bricks_cmake_checks.__system', 'bricks_cmake_core.__system', 'bricks_cmake_groups.__system', 'cip_build_system_platforms.__system', 'cmake', 'dmc_types.generic', 'eco.generic', 'geoml.generic', 'jsoncpp.generic', 'make', 'mf_common.cus_only', 'mf_common_types.cus_only', 'mf_drvwarnsm_core.cus_only', 'mf_drvwarnsm_core_types.cus_only', 'mf_lsca.cus_only', 'mf_lsca_types.cus_only', 'mf_lvmd_types.generic', 'mf_manager.cus_only', 'mf_manager_types.generic', 'mf_memory_parking_types.generic', 'mf_parksm_core.cus_only', 'mf_parksm_core_types.generic', 'mf_pdwarnproc.cus_only', 'mf_pdwarnproc_types.generic', 'mf_taposd.cus_only', 'mf_trjctl.cus_only', 'mf_trjctl_types.generic', 'mf_trjpla.cus_only', 'mf_trjpla_types.cus_only', 'mf_vedodo.cus_only', 'mf_vedodo_types.generic', 'mf_whlprotectproc.cus_only', 'mf_whlprotectproc_types.generic', 'parking_hmi_types.generic', 'plp_hpsd_types.generic', 'plp_log.generic', 'relocalization_types.generic', 'si_core.cus_only', 'si_types.cus_only', 'tce.cus_only', 'tce_types.generic', 'us_drv_types.generic', 'us_em.generic', 'us_em_types.generic', 'us_processing.cus_only', 'us_processing_types.cus_only', 'vehicle_types.generic', 'viewcontroller_types.cus_only']}, 'vs2017': {'deploy': ['appdemo_drvwarnsm.cus_only', 'appdemo_drvwarnsm_types.generic', 'appdemo_hmih.cus_only', 'appdemo_hmih_types.cus_only', 'appdemo_parksm.cus_only', 'appdemo_parksm_types.cus_only', 'appdemo_tonh.cus_only', 'appdemo_tonh_types.generic', 'avga_swc.cus_only', 'avga_swc_types.generic', 'dmc_types.generic', 'eco.generic', 'geoml.generic', 'mf_common.cus_only', 'mf_common_types.cus_only', 'mf_drvwarnsm_core.cus_only', 'mf_drvwarnsm_core_types.cus_only', 'mf_lsca.cus_only', 'mf_lsca_types.cus_only', 'mf_lvmd_types.generic', 'mf_manager.cus_only', 'mf_manager_types.generic', 'mf_memory_parking_types.generic', 'mf_parksm_core.cus_only', 'mf_parksm_core_types.generic', 'mf_pdwarnproc.cus_only', 'mf_pdwarnproc_types.generic', 'mf_plot.cus_only', 'mf_taposd.cus_only', 'mf_trjctl.cus_only', 'mf_trjctl_types.generic', 'mf_trjpla.cus_only', 'mf_trjpla_types.cus_only', 'mf_vedodo.cus_only', 'mf_vedodo_types.generic', 'mf_whlprotectproc.cus_only', 'mf_whlprotectproc_types.generic', 'parking_hmi_types.generic', 'plp_hpsd_types.generic', 'plp_log.generic', 'relocalization_types.generic', 'si_core.cus_only', 'si_types.cus_only', 'tce.cus_only', 'tce_types.generic', 'us_drv_types.generic', 'us_em.generic', 'us_em_types.generic', 'us_processing.cus_only', 'us_processing_types.cus_only', 'vehicle_types.generic', 'viewcontroller_types.cus_only'], 'production': ['adas_platforms.generic', 'appdemo_drvwarnsm.cus_only', 'appdemo_drvwarnsm_types.generic', 'appdemo_hmih.cus_only', 'appdemo_hmih_types.cus_only', 'appdemo_parksm.cus_only', 'appdemo_parksm_types.cus_only', 'appdemo_tonh.cus_only', 'appdemo_tonh_types.generic', 'appl_srv_layer_types.generic', 'avga_swc.cus_only', 'avga_swc_types.generic', 'carmaker_build_dep', 'cmake', 'dmc_types.generic', 'eco.generic', 'geoml.generic', 'jsoncpp.generic', 'make', 'mf_common.cus_only', 'mf_common_types.cus_only', 'mf_drvwarnsm_core.cus_only', 'mf_drvwarnsm_core_types.cus_only', 'mf_lsca.cus_only', 'mf_lsca_types.cus_only', 'mf_lvmd_types.generic', 'mf_manager.cus_only', 'mf_manager_types.generic', 'mf_memory_parking_types.generic', 'mf_parksm_core.cus_only', 'mf_parksm_core_types.generic', 'mf_pdwarnproc.cus_only', 'mf_pdwarnproc_types.generic', 'mf_plot.cus_only', 'mf_taposd.cus_only', 'mf_trjctl.cus_only', 'mf_trjctl_types.generic', 'mf_trjpla.cus_only', 'mf_trjpla_types.cus_only', 'mf_vedodo.cus_only', 'mf_vedodo_types.generic', 'mf_whlprotectproc.cus_only', 'mf_whlprotectproc_types.generic', 'parking_hmi_types.generic', 'plp_hpsd_types.generic', 'plp_log.generic', 'protobuf', 'python', 'relocalization_types.generic', 'si_core.cus_only', 'si_types.cus_only', 'tce.cus_only', 'tce_types.generic', 'us_drv_types.generic', 'us_em.generic', 'us_em_types.generic', 'us_processing.cus_only', 'us_processing_types.cus_only', 'vehicle_types.generic', 'viewcontroller_types.cus_only'], 'build': ['adas_platforms.generic', 'appl_srv_layer_types.generic', 'bricks_cmake_checks.__system', 'bricks_cmake_core.__system', 'bricks_cmake_groups.__system', 'carmaker_build_dep', 'cip_build_system_platforms.__system', 'cmake', 'jsoncpp.generic', 'make', 'protobuf', 'python'], 'system': ['bricks_cmake_checks.__system', 'bricks_cmake_core.__system', 'bricks_cmake_groups.__system'], 'platform': 'cip_build_system_platforms.__system', 'all': ['adas_platforms.generic', 'appdemo_drvwarnsm.cus_only', 'appdemo_drvwarnsm_types.generic', 'appdemo_hmih.cus_only', 'appdemo_hmih_types.cus_only', 'appdemo_parksm.cus_only', 'appdemo_parksm_types.cus_only', 'appdemo_tonh.cus_only', 'appdemo_tonh_types.generic', 'appl_srv_layer_types.generic', 'avga_swc.cus_only', 'avga_swc_types.generic', 'bricks_cmake_checks.__system', 'bricks_cmake_core.__system', 'bricks_cmake_groups.__system', 'carmaker_build_dep', 'cip_build_system_platforms.__system', 'cmake', 'dmc_types.generic', 'eco.generic', 'geoml.generic', 'jsoncpp.generic', 'make', 'mf_common.cus_only', 'mf_common_types.cus_only', 'mf_drvwarnsm_core.cus_only', 'mf_drvwarnsm_core_types.cus_only', 'mf_lsca.cus_only', 'mf_lsca_types.cus_only', 'mf_lvmd_types.generic', 'mf_manager.cus_only', 'mf_manager_types.generic', 'mf_memory_parking_types.generic', 'mf_parksm_core.cus_only', 'mf_parksm_core_types.generic', 'mf_pdwarnproc.cus_only', 'mf_pdwarnproc_types.generic', 'mf_plot.cus_only', 'mf_taposd.cus_only', 'mf_trjctl.cus_only', 'mf_trjctl_types.generic', 'mf_trjpla.cus_only', 'mf_trjpla_types.cus_only', 'mf_vedodo.cus_only', 'mf_vedodo_types.generic', 'mf_whlprotectproc.cus_only', 'mf_whlprotectproc_types.generic', 'parking_hmi_types.generic', 'plp_hpsd_types.generic', 'plp_log.generic', 'protobuf', 'python', 'relocalization_types.generic', 'si_core.cus_only', 'si_types.cus_only', 'tce.cus_only', 'tce_types.generic', 'us_drv_types.generic', 'us_em.generic', 'us_em_types.generic', 'us_processing.cus_only', 'us_processing_types.cus_only', 'vehicle_types.generic', 'viewcontroller_types.cus_only']}}
            requirements = {'vs2017_debug': {'build': {'jsoncpp.generic': 'jsoncpp.generic/1.9.7@cip/releases', 'appl_srv_layer_types.generic': 'appl_srv_layer_types.generic/5.1.0@cip/releases', 'adas_platforms.generic': 'adas_platforms.generic/6.0.54@cip/releases', 'protobuf': 'protobuf/3.11.4-tb1@3rdparty/releases', 'carmaker_build_dep': 'carmaker_build_dep/8.1.1@3rdparty/release', 'cmake': 'cmake/3.25.0@3rdparty/releases', 'bricks_cmake_groups.__system': 'bricks_cmake_groups.__system/1.12.2@cip/releases', 'cip_build_system_platforms.__system': 'cip_build_system_platforms.__system/3.55.14@cip/releases', 'make': 'make/4.4.1@3rdparty/releases', 'bricks_cmake_checks.__system': 'bricks_cmake_checks.__system/1.8.0@cip/releases', 'bricks_cmake_core.__system': 'bricks_cmake_core.__system/1.4.0@cip/releases'}, 'deploy': {'appdemo_tonh_types.generic': 'appdemo_tonh_types.generic/6.1.1@cip/releases', 'mf_plot.cus_only': 'mf_plot.cus_only/4.1.0@cip/releases', 'mf_whlprotectproc_types.generic': 'mf_whlprotectproc_types.generic/5.1.0@cip/releases', 'mf_pdwarnproc_types.generic': 'mf_pdwarnproc_types.generic/7.1.0@cip/releases', 'appdemo_drvwarnsm_types.generic': 'appdemo_drvwarnsm_types.generic/6.1.0@cip/releases', 'vehicle_types.generic': 'vehicle_types.generic/7.1.0@cip/releases', 'mf_lvmd_types.generic': 'mf_lvmd_types.generic/3.0.3@cip/releases', 'geoml.generic': 'geoml.generic/4.2.3@cip/releases', 'mf_lsca_types.cus_only': 'mf_lsca_types.cus_only/6.1.0@cip/releases', 'mf_common_types.cus_only': 'mf_common_types.cus_only/6.1.0@cip/releases', 'mf_common.cus_only': 'mf_common.cus_only/6.6.0@cip/releases', 'eco.generic': 'eco.generic/10.4.1-rc9@cip/releases', 'parking_hmi_types.generic': 'parking_hmi_types.generic/1.1.4@cip/releases', 'mf_parksm_core_types.generic': 'mf_parksm_core_types.generic/7.1.2@cip/releases', 'mf_trjpla_types.cus_only': 'mf_trjpla_types.cus_only/12.2.2@cip/releases', 'appdemo_parksm_types.cus_only': 'appdemo_parksm_types.cus_only/7.2.2@cip/releases', 'mf_memory_parking_types.generic': 'mf_memory_parking_types.generic/4.1.0@cip/releases', 'appdemo_hmih_types.cus_only': 'appdemo_hmih_types.cus_only/8.2.0-rc1@cip/releases', 'si_types.cus_only': 'si_types.cus_only/12.2.1@cip/releases', 'mf_whlprotectproc.cus_only': 'mf_whlprotectproc.cus_only/4.0.4@cip/releases', 'plp_log.generic': 'plp_log.generic/1.0.7@cip/releases', 'relocalization_types.generic': 'relocalization_types.generic/3.1.0@cip/releases', 'mf_pdwarnproc.cus_only': 'mf_pdwarnproc.cus_only/7.1.3@cip/releases', 'mf_parksm_core.cus_only': 'mf_parksm_core.cus_only/9.3.0-rc1@cip/releases', 'mf_trjctl_types.generic': 'mf_trjctl_types.generic/8.1.2@cip/releases', 'plp_hpsd_types.generic': 'plp_hpsd_types.generic/1.0.0@cip/releases', 'appdemo_drvwarnsm.cus_only': 'appdemo_drvwarnsm.cus_only/5.1.3@cip/releases', 'dmc_types.generic': 'dmc_types.generic/2.0.0@cip/releases', 'mf_trjpla.cus_only': 'mf_trjpla.cus_only/8.0.2@cip/releases', 'mf_taposd.cus_only': 'mf_taposd.cus_only/12.0.3@cip/releases', 'mf_manager_types.generic': 'mf_manager_types.generic/7.1.1@cip/releases', 'avga_swc_types.generic': 'avga_swc_types.generic/2.0.3@cip/releases', 'mf_vedodo_types.generic': 'mf_vedodo_types.generic/6.2.2@cip/releases', 'appdemo_hmih.cus_only': 'appdemo_hmih.cus_only/8.0.3-pre6@cip/releases', 'viewcontroller_types.cus_only': 'viewcontroller_types.cus_only/8.2.7@cip/releases', 'mf_drvwarnsm_core_types.cus_only': 'mf_drvwarnsm_core_types.cus_only/6.1.0@cip/releases', 'mf_vedodo.cus_only': 'mf_vedodo.cus_only/6.1.8-pre1@cip/releases', 'tce_types.generic': 'tce_types.generic/5.1.1@cip/releases', 'us_em_types.generic': 'us_em_types.generic/4.1.0@cip/releases', 'appdemo_parksm.cus_only': 'appdemo_parksm.cus_only/7.1.3@cip/releases', 'mf_trjctl.cus_only': 'mf_trjctl.cus_only/9.2.0@cip/releases', 'si_core.cus_only': 'si_core.cus_only/14.2.0-jd1@cip/releases', 'appdemo_tonh.cus_only': 'appdemo_tonh.cus_only/5.0.3-pre5@cip/releases', 'tce.cus_only': 'tce.cus_only/5.1.4@cip/releases', 'us_drv_types.generic': 'us_drv_types.generic/3.6.0@cip/releases', 'avga_swc.cus_only': 'avga_swc.cus_only/2.0.3-dev1@cip/releases', 'mf_lsca.cus_only': 'mf_lsca.cus_only/4.0.2-rc3@cip/releases', 'us_processing.cus_only': 'us_processing.cus_only/9.7.8-pre@cip/releases', 'us_processing_types.cus_only': 'us_processing_types.cus_only/8.5.0@cip/releases', 'mf_manager.cus_only': 'mf_manager.cus_only/5.0.6-dev2@cip/releases', 'mf_drvwarnsm_core.cus_only': 'mf_drvwarnsm_core.cus_only/5.1.3@cip/releases', 'us_em.generic': 'us_em.generic/6.3.5-pre@cip/releases'}}, 'ubuntu_20_04_x86_64': {'build': {'appl_srv_layer_types.generic': 'appl_srv_layer_types.generic/5.1.0@cip/releases', 'adas_platforms.generic': 'adas_platforms.generic/6.0.54@cip/releases', 'cmake': 'cmake/3.25.0@3rdparty/releases', 'bricks_cmake_groups.__system': 'bricks_cmake_groups.__system/1.12.2@cip/releases', 'cip_build_system_platforms.__system': 'cip_build_system_platforms.__system/3.55.14@cip/releases', 'make': 'make/4.4.1@3rdparty/releases', 'bricks_cmake_checks.__system': 'bricks_cmake_checks.__system/1.8.0@cip/releases', 'bricks_cmake_core.__system': 'bricks_cmake_core.__system/1.4.0@cip/releases'}, 'deploy': {'mf_vedodo_types.generic': 'mf_vedodo_types.generic/6.2.2@cip/releases', 'us_em.generic': 'us_em.generic/6.3.5-pre@cip/releases', 'eco.generic': 'eco.generic/10.4.1-rc9@cip/releases', 'us_em_types.generic': 'us_em_types.generic/4.1.0@cip/releases', 'us_processing_types.cus_only': 'us_processing_types.cus_only/8.5.0@cip/releases', 'geoml.generic': 'geoml.generic/4.2.3@cip/releases', 'appdemo_hmih_types.cus_only': 'appdemo_hmih_types.cus_only/8.2.0-rc1@cip/releases', 'mf_lvmd_types.generic': 'mf_lvmd_types.generic/3.0.3@cip/releases', 'parking_hmi_types.generic': 'parking_hmi_types.generic/1.1.4@cip/releases', 'mf_whlprotectproc_types.generic': 'mf_whlprotectproc_types.generic/5.1.0@cip/releases', 'mf_common_types.cus_only': 'mf_common_types.cus_only/6.1.0@cip/releases', 'mf_trjpla_types.cus_only': 'mf_trjpla_types.cus_only/12.2.2@cip/releases', 'vehicle_types.generic': 'vehicle_types.generic/7.1.0@cip/releases', 'mf_pdwarnproc_types.generic': 'mf_pdwarnproc_types.generic/7.1.0@cip/releases', 'appdemo_parksm_types.cus_only': 'appdemo_parksm_types.cus_only/7.2.2@cip/releases', 'appdemo_drvwarnsm_types.generic': 'appdemo_drvwarnsm_types.generic/6.1.0@cip/releases', 'mf_memory_parking_types.generic': 'mf_memory_parking_types.generic/4.1.0@cip/releases', 'mf_lsca_types.cus_only': 'mf_lsca_types.cus_only/6.1.0@cip/releases', 'mf_vedodo.cus_only': 'mf_vedodo.cus_only/6.1.8-pre1@cip/releases', 'tce_types.generic': 'tce_types.generic/5.1.1@cip/releases', 'mf_lsca.cus_only': 'mf_lsca.cus_only/4.0.2-rc3@cip/releases', 'dmc_types.generic': 'dmc_types.generic/2.0.0@cip/releases', 'mf_trjctl_types.generic': 'mf_trjctl_types.generic/8.1.2@cip/releases', 'plp_hpsd_types.generic': 'plp_hpsd_types.generic/1.0.0@cip/releases', 'si_types.cus_only': 'si_types.cus_only/12.2.1@cip/releases', 'mf_parksm_core_types.generic': 'mf_parksm_core_types.generic/7.1.2@cip/releases', 'mf_manager.cus_only': 'mf_manager.cus_only/5.0.6-dev2@cip/releases', 'mf_manager_types.generic': 'mf_manager_types.generic/7.1.1@cip/releases', 'mf_common.cus_only': 'mf_common.cus_only/6.6.0@cip/releases', 'jsoncpp.generic': 'jsoncpp.generic/1.9.7@cip/releases', 'avga_swc_types.generic': 'avga_swc_types.generic/2.0.3@cip/releases', 'plp_log.generic': 'plp_log.generic/1.0.7@cip/releases', 'mf_pdwarnproc.cus_only': 'mf_pdwarnproc.cus_only/7.1.3@cip/releases', 'mf_drvwarnsm_core_types.cus_only': 'mf_drvwarnsm_core_types.cus_only/6.1.0@cip/releases', 'us_drv_types.generic': 'us_drv_types.generic/3.6.0@cip/releases', 'mf_drvwarnsm_core.cus_only': 'mf_drvwarnsm_core.cus_only/5.1.3@cip/releases', 'mf_whlprotectproc.cus_only': 'mf_whlprotectproc.cus_only/4.0.4@cip/releases', 'mf_parksm_core.cus_only': 'mf_parksm_core.cus_only/9.3.0-rc1@cip/releases', 'appdemo_tonh_types.generic': 'appdemo_tonh_types.generic/6.1.1@cip/releases', 'appdemo_parksm.cus_only': 'appdemo_parksm.cus_only/7.1.3@cip/releases', 'mf_trjpla.cus_only': 'mf_trjpla.cus_only/8.0.2@cip/releases', 'mf_taposd.cus_only': 'mf_taposd.cus_only/12.0.3@cip/releases', 'appdemo_drvwarnsm.cus_only': 'appdemo_drvwarnsm.cus_only/5.1.3@cip/releases', 'relocalization_types.generic': 'relocalization_types.generic/3.1.0@cip/releases', 'viewcontroller_types.cus_only': 'viewcontroller_types.cus_only/8.2.7@cip/releases', 'appdemo_tonh.cus_only': 'appdemo_tonh.cus_only/5.0.3-pre5@cip/releases', 'appdemo_hmih.cus_only': 'appdemo_hmih.cus_only/8.0.3-pre6@cip/releases', 'mf_trjctl.cus_only': 'mf_trjctl.cus_only/9.2.0@cip/releases', 'avga_swc.cus_only': 'avga_swc.cus_only/2.0.3-dev1@cip/releases', 'us_processing.cus_only': 'us_processing.cus_only/9.7.8-pre@cip/releases', 'si_core.cus_only': 'si_core.cus_only/14.2.0-jd1@cip/releases', 'tce.cus_only': 'tce.cus_only/5.1.4@cip/releases'}}, 'ubuntu_20_04_x86_64-release': {'build': {'appl_srv_layer_types.generic': 'appl_srv_layer_types.generic/5.1.0@cip/releases', 'adas_platforms.generic': 'adas_platforms.generic/6.0.54@cip/releases', 'cmake': 'cmake/3.25.0@3rdparty/releases', 'bricks_cmake_groups.__system': 'bricks_cmake_groups.__system/1.12.2@cip/releases', 'cip_build_system_platforms.__system': 'cip_build_system_platforms.__system/3.55.14@cip/releases', 'make': 'make/4.4.1@3rdparty/releases', 'bricks_cmake_checks.__system': 'bricks_cmake_checks.__system/1.8.0@cip/releases', 'bricks_cmake_core.__system': 'bricks_cmake_core.__system/1.4.0@cip/releases'}, 'deploy': {'mf_vedodo_types.generic': 'mf_vedodo_types.generic/6.2.2@cip/releases', 'avga_swc.cus_only': 'avga_swc.cus_only/2.0.3-dev1@cip/releases', 'avga_swc_types.generic': 'avga_swc_types.generic/2.0.3@cip/releases', 'appdemo_drvwarnsm_types.generic': 'appdemo_drvwarnsm_types.generic/6.1.0@cip/releases', 'vehicle_types.generic': 'vehicle_types.generic/7.1.0@cip/releases', 'mf_lsca_types.cus_only': 'mf_lsca_types.cus_only/6.1.0@cip/releases', 'mf_common_types.cus_only': 'mf_common_types.cus_only/6.1.0@cip/releases', 'eco.generic': 'eco.generic/10.4.1-rc9@cip/releases', 'mf_common.cus_only': 'mf_common.cus_only/6.6.0@cip/releases', 'geoml.generic': 'geoml.generic/4.2.3@cip/releases', 'jsoncpp.generic': 'jsoncpp.generic/1.9.7@cip/releases', 'relocalization_types.generic': 'relocalization_types.generic/3.1.0@cip/releases', 'mf_manager.cus_only': 'mf_manager.cus_only/5.0.6-dev2@cip/releases', 'mf_manager_types.generic': 'mf_manager_types.generic/7.1.1@cip/releases', 'mf_parksm_core_types.generic': 'mf_parksm_core_types.generic/7.1.2@cip/releases', 'mf_trjpla_types.cus_only': 'mf_trjpla_types.cus_only/12.2.2@cip/releases', 'plp_hpsd_types.generic': 'plp_hpsd_types.generic/1.0.0@cip/releases', 'mf_memory_parking_types.generic': 'mf_memory_parking_types.generic/4.1.0@cip/releases', 'mf_drvwarnsm_core.cus_only': 'mf_drvwarnsm_core.cus_only/5.1.3@cip/releases', 'mf_drvwarnsm_core_types.cus_only': 'mf_drvwarnsm_core_types.cus_only/6.1.0@cip/releases', 'si_types.cus_only': 'si_types.cus_only/12.2.1@cip/releases', 'mf_whlprotectproc.cus_only': 'mf_whlprotectproc.cus_only/4.0.4@cip/releases', 'mf_whlprotectproc_types.generic': 'mf_whlprotectproc_types.generic/5.1.0@cip/releases', 'mf_parksm_core.cus_only': 'mf_parksm_core.cus_only/9.3.0-rc1@cip/releases', 'mf_trjctl_types.generic': 'mf_trjctl_types.generic/8.1.2@cip/releases', 'appdemo_parksm_types.cus_only': 'appdemo_parksm_types.cus_only/7.2.2@cip/releases', 'appdemo_hmih_types.cus_only': 'appdemo_hmih_types.cus_only/8.2.0-rc1@cip/releases', 'mf_lvmd_types.generic': 'mf_lvmd_types.generic/3.0.3@cip/releases', 'parking_hmi_types.generic': 'parking_hmi_types.generic/1.1.4@cip/releases', 'mf_pdwarnproc_types.generic': 'mf_pdwarnproc_types.generic/7.1.0@cip/releases', 'mf_pdwarnproc.cus_only': 'mf_pdwarnproc.cus_only/7.1.3@cip/releases', 'us_em_types.generic': 'us_em_types.generic/4.1.0@cip/releases', 'appdemo_parksm.cus_only': 'appdemo_parksm.cus_only/7.1.3@cip/releases', 'dmc_types.generic': 'dmc_types.generic/2.0.0@cip/releases', 'tce_types.generic': 'tce_types.generic/5.1.1@cip/releases', 'mf_trjpla.cus_only': 'mf_trjpla.cus_only/8.0.2@cip/releases', 'mf_taposd.cus_only': 'mf_taposd.cus_only/12.0.3@cip/releases', 'plp_log.generic': 'plp_log.generic/1.0.7@cip/releases', 'us_processing.cus_only': 'us_processing.cus_only/9.7.8-pre@cip/releases', 'us_drv_types.generic': 'us_drv_types.generic/3.6.0@cip/releases', 'us_processing_types.cus_only': 'us_processing_types.cus_only/8.5.0@cip/releases', 'appdemo_drvwarnsm.cus_only': 'appdemo_drvwarnsm.cus_only/5.1.3@cip/releases', 'appdemo_tonh.cus_only': 'appdemo_tonh.cus_only/5.0.3-pre5@cip/releases', 'appdemo_tonh_types.generic': 'appdemo_tonh_types.generic/6.1.1@cip/releases', 'us_em.generic': 'us_em.generic/6.3.5-pre@cip/releases', 'appdemo_hmih.cus_only': 'appdemo_hmih.cus_only/8.0.3-pre6@cip/releases', 'viewcontroller_types.cus_only': 'viewcontroller_types.cus_only/8.2.7@cip/releases', 'mf_trjctl.cus_only': 'mf_trjctl.cus_only/9.2.0@cip/releases', 'si_core.cus_only': 'si_core.cus_only/14.2.0-jd1@cip/releases', 'tce.cus_only': 'tce.cus_only/5.1.4@cip/releases', 'mf_vedodo.cus_only': 'mf_vedodo.cus_only/6.1.8-pre1@cip/releases', 'mf_lsca.cus_only': 'mf_lsca.cus_only/4.0.2-rc3@cip/releases'}}, 'vs2017': {'build': {'appl_srv_layer_types.generic': 'appl_srv_layer_types.generic/5.1.0@cip/releases', 'jsoncpp.generic': 'jsoncpp.generic/1.9.7@cip/releases', 'carmaker_build_dep': 'carmaker_build_dep/8.1.1@3rdparty/release', 'adas_platforms.generic': 'adas_platforms.generic/6.0.54@cip/releases', 'python': 'python/3.9.13@3rdparty/releases', 'protobuf': 'protobuf/3.11.4-tb1@3rdparty/releases', 'cmake': 'cmake/3.25.0@3rdparty/releases', 'bricks_cmake_groups.__system': 'bricks_cmake_groups.__system/1.12.2@cip/releases', 'cip_build_system_platforms.__system': 'cip_build_system_platforms.__system/3.55.14@cip/releases', 'make': 'make/4.4.1@3rdparty/releases', 'bricks_cmake_checks.__system': 'bricks_cmake_checks.__system/1.8.0@cip/releases', 'bricks_cmake_core.__system': 'bricks_cmake_core.__system/1.4.0@cip/releases'}, 'deploy': {'us_processing.cus_only': 'us_processing.cus_only/9.7.8-pre@cip/releases', 'eco.generic': 'eco.generic/10.4.1-rc9@cip/releases', 'mf_vedodo_types.generic': 'mf_vedodo_types.generic/6.2.2@cip/releases', 'vehicle_types.generic': 'vehicle_types.generic/7.1.0@cip/releases', 'us_drv_types.generic': 'us_drv_types.generic/3.6.0@cip/releases', 'us_processing_types.cus_only': 'us_processing_types.cus_only/8.5.0@cip/releases', 'geoml.generic': 'geoml.generic/4.2.3@cip/releases', 'relocalization_types.generic': 'relocalization_types.generic/3.1.0@cip/releases', 'appdemo_parksm_types.cus_only': 'appdemo_parksm_types.cus_only/7.2.2@cip/releases', 'mf_common_types.cus_only': 'mf_common_types.cus_only/6.1.0@cip/releases', 'mf_lsca_types.cus_only': 'mf_lsca_types.cus_only/6.1.0@cip/releases', 'mf_parksm_core.cus_only': 'mf_parksm_core.cus_only/9.3.0-rc1@cip/releases', 'mf_common.cus_only': 'mf_common.cus_only/6.6.0@cip/releases', 'mf_parksm_core_types.generic': 'mf_parksm_core_types.generic/7.1.2@cip/releases', 'mf_trjpla_types.cus_only': 'mf_trjpla_types.cus_only/12.2.2@cip/releases', 'si_types.cus_only': 'si_types.cus_only/12.2.1@cip/releases', 'mf_trjctl_types.generic': 'mf_trjctl_types.generic/8.1.2@cip/releases', 'plp_hpsd_types.generic': 'plp_hpsd_types.generic/1.0.0@cip/releases', 'mf_memory_parking_types.generic': 'mf_memory_parking_types.generic/4.1.0@cip/releases', 'appdemo_drvwarnsm_types.generic': 'appdemo_drvwarnsm_types.generic/6.1.0@cip/releases', 'appdemo_hmih.cus_only': 'appdemo_hmih.cus_only/8.0.3-pre6@cip/releases', 'mf_drvwarnsm_core_types.cus_only': 'mf_drvwarnsm_core_types.cus_only/6.1.0@cip/releases', 'viewcontroller_types.cus_only': 'viewcontroller_types.cus_only/8.2.7@cip/releases', 'mf_pdwarnproc_types.generic': 'mf_pdwarnproc_types.generic/7.1.0@cip/releases', 'mf_lvmd_types.generic': 'mf_lvmd_types.generic/3.0.3@cip/releases', 'mf_whlprotectproc_types.generic': 'mf_whlprotectproc_types.generic/5.1.0@cip/releases', 'parking_hmi_types.generic': 'parking_hmi_types.generic/1.1.4@cip/releases', 'appdemo_hmih_types.cus_only': 'appdemo_hmih_types.cus_only/8.2.0-rc1@cip/releases', 'mf_plot.cus_only': 'mf_plot.cus_only/4.1.0@cip/releases', 'appdemo_tonh.cus_only': 'appdemo_tonh.cus_only/5.0.3-pre5@cip/releases', 'appdemo_tonh_types.generic': 'appdemo_tonh_types.generic/6.1.1@cip/releases', 'mf_trjpla.cus_only': 'mf_trjpla.cus_only/8.0.2@cip/releases', 'mf_taposd.cus_only': 'mf_taposd.cus_only/12.0.3@cip/releases', 'plp_log.generic': 'plp_log.generic/1.0.7@cip/releases', 'mf_manager_types.generic': 'mf_manager_types.generic/7.1.1@cip/releases', 'avga_swc_types.generic': 'avga_swc_types.generic/2.0.3@cip/releases', 'us_em_types.generic': 'us_em_types.generic/4.1.0@cip/releases', 'tce_types.generic': 'tce_types.generic/5.1.1@cip/releases', 'mf_drvwarnsm_core.cus_only': 'mf_drvwarnsm_core.cus_only/5.1.3@cip/releases', 'mf_pdwarnproc.cus_only': 'mf_pdwarnproc.cus_only/7.1.3@cip/releases', 'mf_vedodo.cus_only': 'mf_vedodo.cus_only/6.1.8-pre1@cip/releases', 'si_core.cus_only': 'si_core.cus_only/14.2.0-jd1@cip/releases', 'mf_trjctl.cus_only': 'mf_trjctl.cus_only/9.2.0@cip/releases', 'dmc_types.generic': 'dmc_types.generic/2.0.0@cip/releases', 'appdemo_drvwarnsm.cus_only': 'appdemo_drvwarnsm.cus_only/5.1.3@cip/releases', 'us_em.generic': 'us_em.generic/6.3.5-pre@cip/releases', 'mf_whlprotectproc.cus_only': 'mf_whlprotectproc.cus_only/4.0.4@cip/releases', 'tce.cus_only': 'tce.cus_only/5.1.4@cip/releases', 'appdemo_parksm.cus_only': 'appdemo_parksm.cus_only/7.1.3@cip/releases', 'mf_lsca.cus_only': 'mf_lsca.cus_only/4.0.2-rc3@cip/releases', 'avga_swc.cus_only': 'avga_swc.cus_only/2.0.3-dev1@cip/releases', 'mf_manager.cus_only': 'mf_manager.cus_only/5.0.6-dev2@cip/releases'}}}
...
""")
    ...
    def source(self):
        ...
        scm = {'revision': '5114fa088351761c52ee8e0e46468c76308fe493', 'repository': 'git@github-am.geo.conti.de:ADAS/mf_sil.git', 'branch': 'master'}
        scm_repository = 'git@github-am.geo.conti.de:ADAS/mf_sil.git'
        scm_revision = '5114fa088351761c52ee8e0e46468c76308fe493'
