...
Vhcl_Register (void)
{
    ...
    ExtSuspForces_Register_CM4SL();
    SuspEF_Spring_Register_CM4SL();
    SuspEF_Damper_Register_CM4SL();
    SuspEF_Buffer_Register_CM4SL();
    SuspEF_Stabi_Register_CM4SL();
    ...
    EngineCU_Register_CM4SL();

    MotorCU_Register_Basic();
    MotorCU_Register_CM4SL();
...
Vhcl_Calc_Part (double dt, CyclePart_t part)
{
    ...
    if (Vehicle.Model.Source!=VehicleSource_CM4SL && IN_TRAILER_PART(part)) {
	if (SimCore.Trailer.nTrailers != 0) {
