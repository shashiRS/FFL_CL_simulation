...
namespace us_drv
{
  ...
  public:
    ...
    UsDrvSensorState() :
      value(static_cast< underlying_type >(US_SENSOR_STATE_OFF))
    {
    }

    UsDrvSensorState(const do_not_use v) :
      value(static_cast<underlying_type >(v))
    {
    }

    UsDrvSensorState(const UsDrvSensorState& v) :
      value(static_cast<underlying_type >(v))
    {
    }

    DEPRECATED_BEGIN DEPRECATED_END UsDrvSensorState(const underlying_type v) :
      value(v)
    {
    }
    ...
    UsDrvSensorState& operator|=(const do_not_use v)
    {
      value |= static_cast< underlying_type >(v);
      return *this;
    }

    DEPRECATED(UsDrvSensorState&) operator|=(const underlying_type v)
    {
      value |= v;
      return *this;
    }
    ...
    UsDrvSensorState& operator=(const UsDrvSensorState& v)
    {
      value = static_cast< underlying_type >(v);
      return *this;
    }
