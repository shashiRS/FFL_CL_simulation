...
#if defined(CM_CMAKE_AUTOCODE) && defined(MoCo_Brake_Enable)
#include "../../../src/package/MoCo_Brake/MoCo_Brake_Autocode_CarMaker_rtw/MoCo_Brake_Autocode_wrap.h"
#include "../../../src/package/OCTAGONBrake/OCTAGONBrake.h"
#elif defined(CM_CMAKE_AUTOCODE)
#include "../../../src/package/OCTAGONBrake/OCTAGONBrake.h"
#else
/* @@PLUGIN-BEGIN-INCLUDE@@ - Automatically generated code - don't edit! */
#include "MoCo_Brake/MoCo_Brake_CMcoder_CarMaker_rtw/MoCo_Brake_CMcoder_wrap.h"
/* @@PLUGIN-END@@ */
#endif
