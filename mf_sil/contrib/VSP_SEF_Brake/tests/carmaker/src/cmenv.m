...
%
    ...
    ipghome = strcat (getenv ('IPGHOME'),'\');
    arch = 'win64-';
    
    cminstdir10_2_1 = strcat (ipghome,'carmaker\',arch,cmver10_2_1);
    cminstdir10_2 = strcat (ipghome,'carmaker\',arch,cmver10_2);
  
   if exist(cminstdir10_2_1, 'dir')
        cminstdir = cminstdir10_2_1;
   elseif exist(cminstdir10_2, 'dir')
        cminstdir = cminstdir10_2;
   else
       error('Unable to find the supported versions of CarMaker. Verify the CarMaker version or install one of the supported versions');
   end
