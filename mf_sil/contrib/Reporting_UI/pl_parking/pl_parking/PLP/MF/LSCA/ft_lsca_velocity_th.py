...
class TestStepVelocityTH(TestStep):
    ...
    def process(self, **kwargs):
        ...
        if eval_cond2:
            ...
            evaluation1 = f"The LSCA function is enabled event though the ego velocity is outside of the valid range(Car.v = {round(car_v.iat[time_fail_2],3)}[m/s] when LSCA.staticBraking.EbaActive = {val_fail_2}, at {round(ap_time.iat[time_fail_2],3)}[s])."
            # evaluation2 = " ".join(
