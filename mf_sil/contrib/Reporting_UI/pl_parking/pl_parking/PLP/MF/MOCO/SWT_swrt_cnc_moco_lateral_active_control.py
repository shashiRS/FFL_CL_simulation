...
ALIAS = "SWT_swrt_cnc_moco_lateral_active_control"
...
class Step1(TestStep):
    """lateral active control status test step"""
    ...
    def process(self, **kwargs):
        ...
        try:
            ...
            if active_lateral_control in df["activateLaCtrl"].to_list():
                ...
                eval_0 = " ".join(
                    "Signal activations for activateLaCtrl and laDMCCtrlRequest_nu should match 100%.".split()
                )
                ...
                eval_0 = " ".join("No signal activateLaCtrl = True in all measurement".split())
