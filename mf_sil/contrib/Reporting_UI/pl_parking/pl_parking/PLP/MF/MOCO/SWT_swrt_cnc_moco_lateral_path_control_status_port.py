...
ALIAS = "SWT_swrt_cnc_moco_lateral_path_control_status_port"
...
class SWT_swrt_cnc_moco_lateral_path_control_status_port(TestCase):
    """Example test case."""
...
def main(data_folder: Path, temp_dir: Path = None, open_explorer=True):
    ...
    debug(
        SWT_swrt_cnc_moco_lateral_path_control_status_port,
        *test_bsigs,
        temp_dir=temp_dir,
