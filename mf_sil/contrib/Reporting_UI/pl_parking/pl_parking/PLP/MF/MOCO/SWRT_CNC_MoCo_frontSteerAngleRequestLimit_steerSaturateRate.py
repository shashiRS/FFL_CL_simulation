...
ALIAS = "SWRT_CNC_MoCo_frontSteerAngleRequestLimit_steerSaturateRate"
        ...
        try:
            ...
            try:
                for ts, row in df_filtered.iterrows():
                    if (row["frontSteerAngReq_rad_at_wheels"]) > (
...
class SWRT_CNC_MoCo_frontSteerAngleRequestLimit_steerSaturateRate(TestCase):
    """Example test case."""
...
def main(data_folder: Path, temp_dir: Path = None, open_explorer=True):
    ...
    debug(
        SWRT_CNC_MoCo_frontSteerAngleRequestLimit_steerSaturateRate,
        *test_bsigs,
        temp_dir=temp_dir,
