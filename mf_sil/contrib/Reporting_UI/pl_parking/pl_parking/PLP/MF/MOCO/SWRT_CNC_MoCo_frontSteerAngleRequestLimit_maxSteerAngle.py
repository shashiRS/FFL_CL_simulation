...
ALIAS = "SWRT_CNC_MoCo_frontSteerAngleRequestLimit_maxSteerAngle"
        ...
        try:
            ...
            if not df_filtered.empty:
                ...
                for _, car_pos_row in df_filtered.iterrows():
                    front_steer_angle = car_pos_row["frontSteerAngReq_rad_at_wheels"]
                    if ((front_steer_angle) < constants.MoCo.Parameter.AP_V_MAX_STEER_ANG_RAD) and (
                        (front_steer_angle) > (-(constants.MoCo.Parameter.AP_V_MAX_STEER_ANG_RAD))
                    ):
...
class SWRT_CNC_MoCo_frontSteerAngleRequestLimit_maxSteerAngle(TestCase):
    """Example test case."""
...
def main(data_folder: Path, temp_dir: Path = None, open_explorer=True):
    ...
    debug(
        SWRT_CNC_MoCo_frontSteerAngleRequestLimit_maxSteerAngle,
        *test_bsigs,
        temp_dir=temp_dir,
